define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/application_tokens'], (function load__packages__angular_forms__src__directives(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular__src__core__application_tokens) {
  'use strict';
  ...
  var ExistingProviderOfListLOfControlValueAccessorL = () => (ExistingProviderOfListLOfControlValueAccessorL = dart.constFn(providers.ExistingProvider$(ListLOfControlValueAccessorL())))();
  ...
  var L4 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_forms/src/model.dart";
  var L22 = "package:angular_forms/src/directives/ng_form_control.dart";
  var L2 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_forms/src/validators.dart";
  ...
  var L8 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_forms/src/directives/shared.dart";
  ...
  validators$._executeValidators = function _executeValidators(control, validators) {
    let result = new (LinkedMapOfStringL$dynamic()).new();
    for (let i = 0, len = validators[$length]; i < dart.notNull(len); i = i + 1) {
      let validator = validators[$_get](i);
  ...
  (select_control_value_accessor.SelectControlValueAccessor.new = function(element) {
    this[value$] = null;
    this[_optionMap] = new (LinkedMapOfStringL$dynamic()).new();
    this[_idCounter] = 0;
  ...
  dart.setFieldSignature(select_control_value_accessor.NgSelectOption, () => ({
    ...
    [_select$]: dart.fieldType(dart.legacy(select_control_value_accessor.SelectControlValueAccessor)),
