define(['dart_sdk', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data', 'packages/intl/date_symbols'], (function load__packages__intl__intl(dart_sdk, packages__intl__src__plural_rules, packages__intl__number_symbols, packages__intl__number_symbols_data, packages__intl__date_symbols) {
  ...
  var RegExpMatchLToNullN = () => (RegExpMatchLToNullN = dart.constFn(dart.fnType(core.Null, [RegExpMatchL()])))();
  ...
  var _DateFormatFieldLTovoid = () => (_DateFormatFieldLTovoid = dart.constFn(dart.fnType(dart.void, [_DateFormatFieldL()])))();
  ...
  var dynamicAnddynamicTo_DateFormatQuotedFieldL = () => (dynamicAnddynamicTo_DateFormatQuotedFieldL = dart.constFn(dart.fnType(_DateFormatQuotedFieldL(), [dart.dynamic, dart.dynamic])))();
  var _DateFormatPatternFieldL = () => (_DateFormatPatternFieldL = dart.constFn(dart.legacy(intl._DateFormatPatternField)))();
  var dynamicAnddynamicTo_DateFormatPatternFieldL = () => (dynamicAnddynamicTo_DateFormatPatternFieldL = dart.constFn(dart.fnType(_DateFormatPatternFieldL(), [dart.dynamic, dart.dynamic])))();
  var _DateFormatLiteralFieldL = () => (_DateFormatLiteralFieldL = dart.constFn(dart.legacy(intl._DateFormatLiteralField)))();
  var dynamicAnddynamicTo_DateFormatLiteralFieldL = () => (dynamicAnddynamicTo_DateFormatLiteralFieldL = dart.constFn(dart.fnType(_DateFormatLiteralFieldL(), [dart.dynamic, dart.dynamic])))();
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C1 = dart.constMap(StringL(), ObjectL(), []);
    },
    get C2() {
    ...
    get C18() {
      return C18 = dart.constList([C15 || CT.C15, C16 || CT.C16, C17 || CT.C17], _CompactFormatTypeL());
    },
    get C19() {
  ...
  intl_helpers.UninitializedLocaleData$ = dart.generic(F => {
    class UninitializedLocaleData extends core.Object {
      ...
      containsKey(key) {
        return boolL().as(key === "en_US" ? true : this[_throwException]());
      }
      [_throwException]() {
    ...
    dart.setFieldSignature(UninitializedLocaleData, () => ({
      ...
      [_badMessages]: dart.fieldType(dart.legacy(core.List$(dart.legacy(core.String))))
    }));
  ...
  intl.Intl = class Intl extends core.Object {
    static get defaultLocale() {
      ...
      return StringL().as(zoneLocale == null ? intl.Intl._defaultLocale : zoneLocale);
    }
    ...
    static verifiedLocale(newLocale, localeExists, opts) {
      ...
      return StringL().as(dart.dcall(onFailure, [newLocale]));
    }
    ...
    static _plural(howMany, opts) {
      ...
      return StringL().as((t0 = translated, t0 == null ? intl.Intl.pluralLogic(howMany, {zero: zero, one: one, two: two, few: few, many: many, other: other, locale: locale}) : t0));
    }
    ...
    static _gender(targetGender, opts) {
      ...
      let meaning = opts && 'meaning' in opts ? opts.meaning : null;
      let translated = intl.Intl._message(null, locale, name, args, meaning);
      return StringL().as((t0 = translated, t0 == null ? intl.Intl.genderLogic(targetGender, {female: female, male: male, other: other, locale: locale}) : t0));
    }
    ...
    static _select(choice, cases, opts) {
      ...
      return StringL().as((t0$ = translated, t0$ == null ? intl.Intl.selectLogic(choice, cases) : t0$));
    }
    ...
    static withLocale(locale, $function) {
      ...
      return async.runZoned(dart.dynamic, $function, {zoneValues: new (LinkedMapOfObjectL$ObjectL()).from([C0 || CT.C0, canonical])});
    }
  ...
  intl.BidiFormatter = class BidiFormatter extends core.Object {
    ...
    wrapWithSpan(text, opts) {
      ...
      return StringL().as(dart.dsend(result, '+', [dart.test(resetDir) ? this[_resetDir](text, direction, isHtml) : ""]));
    }
  ...
  dart.setFieldSignature(intl.BidiFormatter, () => ({
    ...
    [_alwaysSpan]: dart.fieldType(dart.legacy(core.bool))
  }));
  ...
  dart.setGetterSignature(intl._CompactStyleWithNegative, () => ({
    ...
    allStyles: dart.legacy(core.Iterable$(dart.legacy(intl._CompactStyle)))
  }));
  ...
  dart.setFieldSignature(intl._CompactStyle, () => ({
    ...
    requiredDigits: dart.fieldType(dart.legacy(core.int)),
  ...
  intl.NumberFormat = class NumberFormat extends core.Object {
    ...
    static simpleCurrency(opts) {
      ...
      return new intl.NumberFormat._forPattern(locale, dart.fn(x => x.CURRENCY_PATTERN, NumberSymbolsLToStringL()), {name: name, computeCurrencySymbol: dart.fn(format => {
          let t2;
          return StringL().as((t2 = intl.NumberFormat._simpleCurrencySymbols[$_get](dart.dload(format, 'currencyName')), t2 == null ? dart.dload(format, 'currencyName') : t2));
  ...
  dart.setGetterSignature(intl._CompactNumberFormat, () => ({
    ...
    compactSymbols: dart.legacy(number_symbols.CompactNumberSymbols)
  }));
  ...
  dart.setFieldSignature(intl._CompactNumberFormat, () => ({
    ...
    [_patterns]: dart.fieldType(dart.legacy(core.Map$(dart.legacy(core.int), dart.legacy(core.String)))),
  ...
  intl.DateFormat = class DateFormat extends core.Object {
    ...
    parseLoose(inputString, utc = false) {
      try {
        ...
        let ex = dart.getThrown(e);
        if (FormatExceptionL().is(ex)) {
          return DateTimeL().as(this[_parseLoose](inputString[$toLowerCase](), boolL().as(utc)));
        } else
          throw e;
      }
    }
    ...
    get useNativeDigits() {
      return boolL().as(this[_useNativeDigits] == null ? this[_useNativeDigits] = boolL().as(intl.DateFormat.shouldUseNativeDigitsByDefaultFor(this.locale)) : this[_useNativeDigits]);
    }
    ...
    [_match](pattern) {
      for (let i = 0; i < dart.notNull(intl.DateFormat._matchers[$length]); i = i + 1) {
        ...
        if (match != null) {
          return _DateFormatFieldL().as(dart.dcall(intl.DateFormat._fieldConstructors[$_get](i), [match.group(0), this]));
        }
      }
      return null;
    }
  ...
  dart.setMethodSignature(intl.DateFormat, () => ({
    ...
    parse: dart.fnType(dart.legacy(core.DateTime), [dart.legacy(core.String)], [dart.dynamic]),
    parseLoose: dart.fnType(dart.legacy(core.DateTime), [dart.legacy(core.String)], [dart.dynamic]),
    [_parseLoose]: dart.fnType(dart.dynamic, [dart.legacy(core.String), dart.legacy(core.bool)]),
    parseStrict: dart.fnType(dart.legacy(core.DateTime), [dart.legacy(core.String)], [dart.dynamic]),
    [_parse]: dart.fnType(dart.legacy(core.DateTime), [dart.legacy(core.String)], {strict: dart.dynamic, utc: dart.dynamic}, {}),
    ...
    [_appendPattern]: dart.fnType(dart.dynamic, [dart.legacy(core.String)], [dart.legacy(core.String)]),
  ...
  intl._DateFormatPatternField = class _DateFormatPatternField extends intl._DateFormatField {
    ...
    formatField(date) {
      switch (this.pattern[$_get](0)) {
        ...
        case "G":
        {
          return StringL().as(this.formatEra(date));
        }
        case "h":
        {
        ...
        case "y":
        {
          return StringL().as(this.formatYear(date));
        }
        case "z":
        {
    ...
    parseEnumeratedString(input, possibilities) {
      ...
      results[$sort](dart.fn((a, b) => intL().as(dart.dsend(dart.dload(possibilities[$_get](core.int.as(a)), 'length'), 'compareTo', [dart.dload(possibilities[$_get](core.int.as(b)), 'length')])), dynamicAnddynamicTointL()));
      let longestResult = results[$last];
      input.read(intL().as(dart.dload(possibilities[$_get](core.int.as(longestResult)), 'length')));
    ...
    parseMonth(input, dateFields) {
      ...
      switch (this.width) {
        ...
        default:
        {
          return this.handleNumericField(_StreamL().as(input), FunctionL().as(dart.dload(dateFields, 'setMonth')));
        }
      }
      dart.dput(dateFields, 'month', dart.notNull(this.parseEnumeratedString(_StreamL().as(input), ListL().as(possibilities))) + 1);
    }
    format24Hours(date) {
    ...
    parseStandaloneDay(input) {
      ...
      this.parseEnumeratedString(input, ListL().as(possibilities));
    }
  ...
  dart.setMethodSignature(intl._DateFormatPatternField, () => ({
    ...
    formatEra: dart.fnType(dart.dynamic, [dart.legacy(core.DateTime)]),
    formatYear: dart.fnType(dart.dynamic, [dart.legacy(core.DateTime)]),
    handleNumericField: dart.fnType(dart.void, [dart.legacy(intl._Stream), dart.legacy(core.Function)], [dart.legacy(core.int)]),
    parseEnumeratedString: dart.fnType(dart.legacy(core.int), [dart.legacy(intl._Stream), dart.legacy(core.List)]),
  ...
  intl._LoosePatternField = class _LoosePatternField extends intl._DateFormatPatternField {
    ...
    parseMonth(input, dateFields) {
      if (dart.notNull(this.width) <= 2) {
        this.handleNumericField(_StreamL().as(input), FunctionL().as(dart.dload(dateFields, 'setMonth')));
        return;
      }
  ...
  intl._DateBuilder = class _DateBuilder extends core.Object {
    ...
    verify(s) {
      ...
      this[_verify](intL().as(this.hour24), 0, 23, "hour", s);
      ...
      this[_verify](intL().as(this.hour24), minimumDate, date.hour, "hour", s, date);
  ...
  dart.setMethodSignature(intl._DateBuilder, () => ({
    ...
    verify: dart.fnType(dart.dynamic, [dart.legacy(core.String)]),
    [_verify]: dart.fnType(dart.dynamic, [dart.legacy(core.int), dart.legacy(core.int), dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.String)], [dart.legacy(core.DateTime)]),
