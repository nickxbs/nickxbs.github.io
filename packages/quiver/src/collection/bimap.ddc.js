define(['dart_sdk', 'packages/quiver/src/iterables/concat'], (function load__packages__quiver__src__collection__bimap(dart_sdk, packages__quiver__src__iterables__concat) {
  ...
  var L1 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/quiver/src/collection/lru_map.dart";
  ...
  lru_map.LinkedLruHashMap$ = dart.generic((K, V) => {
    ...
    var KLAnd_LinkedEntryLOfKL$VLToNullN = () => (KLAnd_LinkedEntryLOfKL$VLToNullN = dart.constFn(dart.fnType(core.Null, [KL(), _LinkedEntryLOfKL$VL()])))();
    ...
    class LinkedLruHashMap extends core.Object {
      ...
      removeWhere(test) {
        ...
        }, KLAnd_LinkedEntryLOfKL$VLToNullN()));
  ...
  multimap._BaseMultimap$ = dart.generic((K, V, C) => {
    ...
    var KLAndIterableLOfVLToNullN = () => (KLAndIterableLOfVLToNullN = dart.constFn(dart.fnType(core.Null, [KL(), IterableLOfVL()])))();
...
//# sourceMappingURL=bimap.ddc.js.map
