define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/angular/imperative_view/imperative_view'], (function load__packages__angular_components__laminate__portal__portal(dart_sdk, packages__angular__src__bootstrap__modules, packages__angular_components__utils__disposer__disposer, packages__angular_components__utils__angular__imperative_view__imperative_view) {
  ...
  var ComponentPortalL = () => (ComponentPortalL = dart.constFn(dart.legacy(portal$.ComponentPortal)))();
  ...
  var FutureOfComponentRefL = () => (FutureOfComponentRefL = dart.constFn(async.Future$(ComponentRefL())))();
  ...
  var ComponentRefLToComponentRefL = () => (ComponentRefLToComponentRefL = dart.constFn(dart.fnType(ComponentRefL(), [ComponentRefL()])))();
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/laminate/portal/portal.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  portal$.Portal$ = dart.generic(T => {
    ...
    class Portal extends core.Object {
      attach(host) {
        if (!(host != null)) dart.assertFailed(null, L0, 22, 12, "host != null");
      ...
      detach() {
        ...
        if (!(currentHost != null)) dart.assertFailed(null, L0, 39, 12, "currentHost != null");
    ...
    dart.setMethodSignature(Portal, () => ({
      ...
      attach: dart.fnType(dart.legacy(async.Future$(dart.legacy(T))), [dart.legacy(portal$.PortalHost)]),
      detach: dart.fnType(dart.legacy(async.Future), []),
  ...
  portal$.ComponentPortal$ = dart.generic(T => {
    ...
    dart.setFieldSignature(ComponentPortal, () => ({
      ...
      componentFactory: dart.finalFieldType(dart.legacy(component_factory.ComponentFactory))
    }));
  ...
  (portal$.TemplatePortal.new = function(template, viewContainer) {
    ...
    if (!(this.template != null)) dart.assertFailed(null, L0, 91, 12, "template != null");
    if (!(this.viewContainer != null)) dart.assertFailed(null, L0, 92, 12, "viewContainer != null");
  ...
  portal$.BasePortalHost = class BasePortalHost extends core.Object {
    attach(portal) {
      if (!(portal != null)) dart.assertFailed(null, L0, 152, 12, "portal != null");
    ...
    setPortalDisposer(fn) {
      if (!(this[_detachPortal] == null)) dart.assertFailed(null, L0, 204, 12, "_detachPortal == null");
  ...
  dart.setMethodSignature(portal$.BasePortalHost, () => ({
    ...
    attach: dart.fnType(dart.legacy(async.Future), [dart.legacy(portal$.Portal)]),
    detach: dart.fnType(dart.legacy(async.Future), []),
  ...
  dart.setFieldSignature(portal$.BasePortalHost, () => ({
    ...
    [_attachedPortal]: dart.fieldType(dart.legacy(portal$.Portal)),
  ...
  portal$.PortalHostDirective = class PortalHostDirective extends portal$.BasePortalHost {
    attachComponentPortal(portal) {
      ...
      return FutureOfComponentRefL().value(ref);
    }
  ...
  dart.setMethodSignature(portal$.PortalHostDirective, () => ({
    ...
    attachComponentPortal: dart.fnType(dart.legacy(async.Future$(dart.legacy(component_factory.ComponentRef))), [dart.legacy(portal$.ComponentPortal)]),
  ...
  dart.setSetterSignature(portal$.PortalHostDirective, () => ({
    ...
    portal: dart.legacy(portal$.Portal)
  }));
  ...
  portal$.DomPortalHost = class DomPortalHost extends portal$.BasePortalHost {
    attachComponentPortal(portal) {
      ...
      return this[_imperativeViewUtils$].insertComponent(portal.componentFactory, portal.origin, this[_hostElement$]).then(ComponentRefL(), dart.fn(ref => {
        this.setPortalDisposer(dart.bind(ref, 'destroy'));
        return ref;
      }, ComponentRefLToComponentRefL()));
    }
    attachTemplatePortal(portal) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":
;AAEgB,MAAlB,oBAAc;IAChB;;AAGwB,YAAA,AAAgB,0BAAG;IAAI;sBAER;AACrC,YAAO,AAAc,uBAAG;AACN,MAAlB,sBAAgB,EAAE;IACpB;;;IA5DO;IACS;IACX,oBAAc;;EA2DrB;;;;;;;;;;;;;;;;;;;;;;;;;AAS0B,YAAA,AAAc;IAAW;WAG5B;AAAW,YAAA,AAAc,6BAAO,MAAM;IAAC;;AAGzC,YAAA,AAAc;IAAQ;;AAIhB,MAAvB,AAAc;IAChB;;;IAd0B;;EAAc;;;;;;;;;;;;;;;;;;;;;;0BA+BmB;AAGrD,6BAAmB;AACvB,UAAI,AAAO,MAAD,WAAW;AACa,QAAhC,mBAAmB,AAAO,MAAD;;AAErB,gBAAM,AAAiB,yDACzB,AAAO,MAAD,mBAAmB,gBAAgB;AACf,MAA9B,uBAAsB,UAAJ,GAAG;AAErB,YAAc,+BAAM,GAAG;IACzB;yBAGiE;AACzD,oBAAU,AAAkB,4CAAmB,AAAO,MAAD;AACpB,MAAvC,AAAO,AAAO,MAAR,kBAAwB,UAAR,OAAO;AACa,MAA1C,uBAAoC,UAAlB;AAClB,YAAc,uCAAqB,uCAAgB,OAAO;IAC5D;eAGkB;AAChB,oBAAI;AAKA,QAJF,AAAS,8BAAK,QAAC;AACb,cAAI,MAAM,IAAI;AACE,YAAd,YAAO,MAAM;;;;AAKjB,YAAI,MAAM,IAAI;AACE,UAAd,YAAO,MAAM;;;IAGnB;;8CAvCyB,kBAAuB;IAAvB;IAAuB;AAAhD;;EAAkE;;;;;;;;;;;;;;;;;;;;;0BAmDP;AACzD,UAAI,AAAO,AAAO,MAAR,WAAW;AAGgB,QAFnC,WAAM,wBAAU,AAAC,gDACb,wDACA;;AAEN,YAAO,AACF,AACA,6CADgB,AAAO,MAAD,mBAAmB,AAAO,MAAD,SAAS,2CACnD,QAAC;AACqB,QAA9B,uBAAsB,UAAJ,GAAG;AACrB,cAAO,IAAG;;IAEd;yBAGiE;AAC/D,YAAO,AACF,AACA,+CADkB,qBAAc,AAAO,MAAD,WAAW,AAAO,MAAD,8CAClD,QAAC;AACkC,QAA3C,AAAO,AAAO,MAAR,kBAA4B,UAAZ,AAAI,GAAD;AACK,QAA9B,uBAAsB,UAAJ,GAAG;AACrB,cAAsB,wCAAgB,AAAI,GAAD;;IAE7C;;wCA1BmB,cAAmB;IAAnB;IAAmB;AAAtC;;EAA2D;;;;;;;;;;;;;;;;;AA0Cd,YAAA,AAAO;IAAM;;kDAI1C,aAA8B;IAHxC,eAAS;AAIT,6DAAM,WAAW,EAAE,gBAAgB;AAIrC,IAFF,wBAAkB;AACA,MAAhB,AAAO,iBAAI;;EAEf","file":"portal.ddc.js"}');
  // Exports:
  return {
