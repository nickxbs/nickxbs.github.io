define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular/angular.template'], (function load__packages__angular_components__laminate__overlay__zindexer_template(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular_components__laminate__overlay__zindexer, packages__angular__angular$46template) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["zindexer.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,+BAAW;AAEuC,IAAlD,0BAAuB,4BAAU,cAAM;AAClB,IAArB;EACF;;MATI,4BAAQ;YAAG","file":"zindexer.template.ddc.js"}');
  // Exports:
  return {
