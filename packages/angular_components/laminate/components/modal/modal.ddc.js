define(['dart_sdk', 'packages/angular_components/src/model/action/async_action', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular_components/content/deferred_content_aware', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service'], (function load__packages__angular_components__laminate__components__modal__modal(dart_sdk, packages__angular_components__src__model__action__async_action, packages__angular_components__utils__disposer__disposer, packages__angular_components__src__laminate__overlay__overlay_ref, packages__angular_components__content__deferred_content_aware, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__browser__dom_service__dom_service) {
  ...
  var dynamicToFutureOrOfboolL = () => (dynamicToFutureOrOfboolL = dart.constFn(dart.fnType(FutureOrOfboolL(), [dart.dynamic])))();
  const CT = Object.create(null);
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/laminate/components/modal/modal.dart";
    ...
    open() {
      if (this[_pendingOpen] == null) {
        ...
        this[_pendingOpen] = controller.action.onDone.then(boolL(), dart.fn(completed => {
          ...
          return FutureOrOfboolL().as(completed);
        }, dynamicToFutureOrOfboolL()));
