define(['dart_sdk', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/utils/browser/events/events', 'packages/angular_forms/src/directives', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/focus/focus_interface', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/ui/icon'], (function load__packages__angular_components__material_checkbox__material_checkbox(dart_sdk, packages__angular_components__utils__id_generator__id_generator, packages__angular_components__utils__browser__events__events, packages__angular_forms__src__directives, packages__angular_components__interfaces__has_disabled, packages__angular_components__focus__focus_interface, packages__angular__src__core__change_detection__change_detection, packages__angular_components__model__ui__icon) {
  'use strict';
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/material_checkbox/material_checkbox.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  material_checkbox.MaterialCheckboxComponent = class MaterialCheckboxComponent extends core.Object {
    ...
    toggleChecked() {
      ...
      if (!dart.test(this.indeterminate) && !dart.test(this.checked)) {
        ...
        if (!dart.test(this.indeterminate)) dart.assertFailed(null, L0, 272, 14, "indeterminate");
