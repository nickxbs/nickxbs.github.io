...
import '../utils/id_generator/id_generator.dart' as import27;
...
class ViewMaterialSelectDropdownItemComponent0<T> extends AppView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  ViewMaterialSelectDropdownItemComponent0(AppView<dynamic> parentView, int parentIndex) : super(import6.ViewType.component, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    ...
    this.updateChildClassNonHtml(rootEl, import2.MaterialSelectDropdownItemComponent.hostClass);
  }
  ...
  void detectHostChanges(bool firstCheck) {
    ...
    final currVal_13 = _ctx.id;
    if (import13.checkBinding(_expr_13, currVal_13)) {
      import11.updateAttribute(rootEl, 'id', currVal_13);
      _expr_13 = currVal_13;
    }
    final currVal_14 = _ctx.isSelected;
    if (import13.checkBinding(_expr_14, currVal_14)) {
      import11.updateAttribute(rootEl, 'aria-selected', currVal_14?.toString());
      _expr_14 = currVal_14;
    }
  }
  ...
  void initComponentStyles() {
    ...
    if (identical(styles, null)) {
      (_componentStyles = (styles = (_componentStyles = import5.ComponentStyles.scoped(styles$MaterialSelectDropdownItemComponent, _debugComponentUrl))));
    }
...
class _ViewMaterialSelectDropdownItemComponent1<T> extends AppView<import2.MaterialSelectDropdownItemComponent<T>> {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent1<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent2<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent3<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent4<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent5<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent6<T>(AppView<dynamic> parentView, int parentIndex) {
...
AppView<void> viewFactory_MaterialSelectDropdownItemComponent7<T>(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewMaterialSelectDropdownItemComponentHost0<T> extends AppView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  ComponentRef<import2.MaterialSelectDropdownItemComponent<T>> build() {
    ...
    _MaterialSelectDropdownItemComponent_0_5 = (import9.isDevMode
        ? import23.debugInjectorWrap(import2.MaterialSelectDropdownItemComponent, () {
            return import2.MaterialSelectDropdownItemComponent(rootEl, null, this.injectorGetOptional(import25.DropdownHandle, viewData.parentIndex), this.injectorGetOptional(import26.ActivationHandler, viewData.parentIndex), this.injectorGetOptional(import27.IdGenerator, viewData.parentIndex), _compView_0);
          })
        : import2.MaterialSelectDropdownItemComponent(rootEl, null, this.injectorGetOptional(import25.DropdownHandle, viewData.parentIndex), this.injectorGetOptional(import26.ActivationHandler, viewData.parentIndex), this.injectorGetOptional(import27.IdGenerator, viewData.parentIndex), _compView_0));
    _compView_0.create(_MaterialSelectDropdownItemComponent_0_5, projectedNodes);
    init1(rootEl);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import28.SelectionItem) || identical(token, import29.HasRenderer)) && (0 == nodeIndex))) {
