define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/laminate/portal/portal.template', 'packages/angular_components/model/action/async_action.template', 'packages/angular_components/utils/angular/properties/properties.template'], (function load__packages__angular_components__material_stepper__material_step_template(dart_sdk, packages__angular__angular$46template, packages__angular_components__laminate__portal__portal$46template, packages__angular_components__model__action__async_action$46template, packages__angular_components__utils__angular__properties__properties$46template) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_step.template.dart"],"names":[],"mappings":";;;;;;;;;;;;AAaE,kBAAI;AACF;;AAEa,IAAf,oCAAW;AAEU,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAXI,iCAAQ;YAAG","file":"material_step.template.ddc.js"}');
  // Exports:
  return {
