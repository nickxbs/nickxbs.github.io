define(['dart_sdk', 'packages/angular_components/material_stepper/material_step', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/src/model/action/async_action', 'packages/angular_components/material_stepper/common', 'packages/angular_components/utils/browser/events/events', 'packages/intl/intl'], (function load__packages__angular_components__material_stepper__material_stepper(dart_sdk, packages__angular_components__material_stepper__material_step, packages__angular_components__utils__angular__properties__properties, packages__angular_components__src__model__action__async_action, packages__angular_components__material_stepper__common, packages__angular_components__utils__browser__events__events, packages__intl__intl) {
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/material_stepper/material_stepper.dart";
  ...
  var _stickyHeader = dart.privateName(material_stepper, "_stickyHeader");
  ...
  var activeStepIndex = dart.privateName(material_stepper, "MaterialStepperComponent.activeStepIndex");
  ...
  material_stepper.MaterialStepperComponent = class MaterialStepperComponent extends core.Object {
    ...
    set stickyHeader(value) {
      this[_stickyHeader] = properties.getBool(value);
    }
    jumpStep(index) {
    ...
    set orientation(s) {
      if (!dart.test(common.orientations[$contains](s))) dart.assertFailed(null, L0, 149, 12, "orientations.contains(s)");
      this[_orientation] = s;
    }
    set size(s) {
      if (!dart.test(common.sizes[$contains](s))) dart.assertFailed(null, L0, 159, 12, "sizes.contains(s)");
      this[_size] = s;
    }
    ...
    set legalJumps(s) {
      if (!dart.test(common.jumps[$contains](s))) dart.assertFailed(null, L0, 188, 12, "jumps.contains(s)");
      this[_legalJumps] = s;
  ...
  dart.setGetterSignature(material_stepper.MaterialStepperComponent, () => ({
    ...
    stickyHeader: dart.legacy(core.bool),
  ...
  dart.setFieldSignature(material_stepper.MaterialStepperComponent, () => ({
    ...
    activeStepIndex: dart.fieldType(dart.legacy(core.int)),
    ...
    [_stickyHeader]: dart.fieldType(dart.legacy(core.bool)),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_stepper.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAsDsB;;;;;;IAEhB;;;;;;IACC;;;;;;IA2BA;;;;;;IAyDE;;;;;;IAwDK;;;;;;mBAhIuB;AACjC,UAAuB,YAAnB,0BAAsB,KAAK,GAAE;AACX,MAAtB,AAAe;AACW,MAA1B,2BAAqB,KAAK;AACL,MAArB,AAAgB,wBAAA,OAAhB,uBAAoB,IAAJ;AAGd,MAFF,wBAAkB;AACkB,QAAlC,qBAAe;;IAEnB;;AAGyB;IAAa;qBAWrB;AACe,MAA9B,sBAAgB,mBAAQ,KAAK;IAC/B;aAG0B;AACxB,oBAAI,AAAK,AAAQ,kBAAP,KAAK,oBAAmB,MAAc,uBAAM;AACnC,MAAnB,mBAAc;AACd,YAAO,eAAQ,KAAK;IACtB;gBAEuB,OAAqB;AAKpB,MAAtB,AAAM,KAAD;AACkB,MAAvB,AAAM,KAAD;AAEuB,iBAAO;AACE,MAArC,AAAK,IAAD,qBAAqB,AAAK,IAAD;AAQ3B,MAPF,AAAK,IAAD,SAAS;AACe,QAA1B,AAAW,2BAAW;AACtB,sBAAI,AAAW;AACK,UAAlB,mBAAc;AACd,gBAAO;;AAET,cAAO,eAAwB,aAAhB,wBAAkB;;IAErC;iBAEwB,OAAqB;AAKrB,MAAtB,AAAM,KAAD;AACkB,MAAvB,AAAM,KAAD;AAEuB,iBAAO;AACA,MAAnC,AAAK,IAAD,mBAAmB,AAAK,IAAD;AAIzB,MAHF,AAAK,IAAD,SAAS;AACgB,QAA3B,AAAW,2BAAW;AACtB,cAAO,eAAwB,aAAhB,wBAAkB;;IAErC;oBAWuB;AACrB,qBAAO,AAAa,+BAAS,CAAC;AACd,MAAhB,qBAAe,CAAC;IAClB;aAOgB;AACd,qBAAO,AAAM,wBAAS,CAAC