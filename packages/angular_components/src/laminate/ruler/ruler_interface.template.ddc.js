define(['dart_sdk', 'packages/angular_components/laminate/enums/position.template', 'packages/angular_components/laminate/enums/visibility.template'], (function load__packages__angular_components__src__laminate__ruler__ruler_interface_template(dart_sdk, packages__angular_components__laminate__enums__position$46template, packages__angular_components__laminate__enums__visibility$46template) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["ruler_interface.template.dart"],"names":[],"mappings":";;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,sCAAW;AAEU,IAArB;AACqB,IAArB;EACF;;MATI,mCAAQ;YAAG","file":"ruler_interface.template.ddc.js"}');
  // Exports:
  return {
