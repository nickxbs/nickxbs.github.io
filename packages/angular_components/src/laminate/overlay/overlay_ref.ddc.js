define(['dart_sdk', 'packages/angular_components/laminate/enums/visibility', 'packages/angular/src/core/change_detection/change_detection', 'packages/logging/logging', 'packages/angular_components/laminate/portal/portal', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/angular/imperative_view/imperative_view', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/laminate/enums/position', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/quiver/core'], (function load__packages__angular_components__src__laminate__overlay__overlay_ref(dart_sdk, packages__angular_components__laminate__enums__visibility, packages__angular__src__core__change_detection__change_detection, packages__logging__logging, packages__angular_components__laminate__portal__portal, packages__angular_components__laminate__ruler__dom_ruler, packages__angular_components__utils__browser__dom_service__dom_service, packages__angular_components__utils__angular__imperative_view__imperative_view, packages__angular_components__laminate__overlay__zindexer, packages__angular_components__laminate__enums__position, packages__angular_components__src__utils__async__async_update_scheduler, packages__quiver__core) {
  ...
  var dynamicToRectangleLOfnumL = () => (dynamicToRectangleLOfnumL = dart.constFn(dart.fnType(RectangleLOfnumL(), [dart.dynamic])))();
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/laminate/overlay/overlay_service.dart";
  ...
  dart.defineLazy(CT, {
    ...
    get C9() {
      return C9 = dart.const({
        __proto__: async._EmptyStream.prototype
      });
    },
    get C10() {
  ...
  (overlay_service.OverlayService.new = function(_ngZone, _useDomSynchronously, _renderService, existingInstance) {
    ...
    if (!dart.test(dart.fn(() => {
      if (existingInstance != null) {
        overlay_service.OverlayService._logger.severe("OverlayService must be a singleton: " + "Check that there is no nested overlayBindings or popupBindings");
      }
      return true;
  ...
  overlay_dom_render_service.OverlayDomRenderService = class OverlayDomRenderService extends core.Object {
    ...
    measureContainer() {
      if (!dart.test(this[_useDomSynchronously$0])) {
        return this[_domService$].onWrite().then(RectangleLOfnumL(), dart.fn(_ => this.containerElement.getBoundingClientRect(), dynamicToRectangleLOfnumL()));
      } else {
  ...
  dart.setMethodSignature(overlay_dom_render_service.OverlayDomRenderService, () => ({
    ...
    applyState: dart.fnType(dart.legacy(async.Future), [dart.legacy(overlay_state.OverlayState), dart.legacy(html.HtmlElement)]),
  ...
  (overlay_ref.OverlayRef.new = function(_asyncApplyState, _asyncMeasureSize, _delegatePortalHost, containerElement, overlayElement, _runOutsideAngular, opts) {
    ...
    this[_stateUpdateListener] = this.state.onUpdate.listen(dart.fn(_ => this[_applyChanges](), dynamicToFutureL()));
  ...
  dart.setMethodSignature(overlay_ref.OverlayRef, () => ({
    ...
    [_applyChanges]: dart.fnType(dart.legacy(async.Future), [])
  }));
  ...
  dart.setFieldSignature(overlay_ref.OverlayRef, () => ({
    ...
    [_asyncApplyState$]: dart.finalFieldType(dart.legacy(dart.fnType(dart.legacy(async.Future), [dart.legacy(overlay_state.OverlayState), dart.legacy(html.HtmlElement)]))),
    ...
    [_stateUpdateListener]: dart.fieldType(dart.legacy(async.StreamSubscription))
  }));
