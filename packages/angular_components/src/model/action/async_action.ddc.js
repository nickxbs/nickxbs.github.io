define(['dart_sdk'], (function load__packages__angular_components__src__model__action__async_action(dart_sdk) {
  ...
  var boolLToFutureL = () => (boolLToFutureL = dart.constFn(dart.fnType(FutureL(), [boolL()])))();
  ...
  async_action_controller.AsyncActionController$ = dart.generic(V => {
    ...
    dart.setMethodSignature(AsyncActionController, () => ({
      ...
      execute: dart.fnType(dart.legacy(async.Future), [dart.legacy(dart.fnType(dart.dynamic, []))], {onCancel: dart.legacy(dart.fnType(dart.dynamic, [])), valueOnCancel: dart.legacy(core.Object)}, {}),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["async_action.dart","async_action_controller.dart","delegating_async_action.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA8E8B,0BAAa,WAAb;MAAe;;AAYrB,cAAe,WAAf,oCAAkC,WAAhB;MAAkB;;AAGvC,0BAAW,WAAX;MAAa;;AAIR;MAAO;;AASH;MAAQ;eAST;AAEzB,sBAAI,iBAAW;AAEf,sBAAI;AACsD,UAAxD,WAAM,wBAAW;;AAInB,sBAAI;AACmD,UAArD,WAAM,wBAAW;;AAIsB,QAAzC,AAAqB,kCAAI,eAAe;MAC1C;;;AAOE,sBAAI,iBAAW;AAGf,sBAAI;AACsD,UAAxD,WAAM,wBAAW;;AAGnB,sBAAI;AACmD,UAArD,WAAM,wBAAW;;AAGE,QAArB,uBAAiB;AAGU,aAF3B;;AACI;AACA,mBAAW,sBAAM;;;MACvB;YAUkB;AAEhB,sBAAI,iBAAW;AAGf,sBAAI;AACsD,UAAxD,WAAM,wBAAW;;AAGnB,sBAAI;AACmD,UAArD,WAAM,wBAAW;;AAIuB,QAA1C,AAAoB,iCAAI,iBAAiB;MAC3C;;gCAhGS,SACA,UACA,sBACA,qBACA,eACA,kBACA;MAVJ,uBAAiB;MAIb;MACA;MACA;MACA;MACA;MACA;MACA;;IAAY;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AC/CnB,YAAI,AAAQ,iBAAG;AAQG,UAPhB,gBAAU,4BACN,AAAkB,gCAClB,AAAgB,8BAChB,4BACA,2BACA,cAAM,+BACN,cAAM,kCACN,cAAM;;AAEZ,cAAO;MACT;cASwB;YAAwB;YAAY;;AAM1D,cAAc,wBAAU;AACtB,wBAAI;AAC+D,YAAjE,WAAM,wBAAW;;AAEL,UAAd,gBAAU;AAGV,gBAAO,AAAgB,0CAAK,QAAC;AACF,YAAzB,mBAAa,YAAY;AACrB,gCAAgB,WAAC;AACkB,YAAvC,AAAgB,+BAAS,aAAa;AACtC,gBAAI,aAAa;AAEf,oBAAO,AAAa,uCAAK,QAAC;AACD,gBAAvB,wBAAkB,IAAI;;;AAGZ,cAAZ,cAAQ;AAIR,kBAAI,AAAS,QAAD,IAAI;AAC2B,gBAAzC,AAAkB,iCAAS,aAAa;;AAEpC,gCAAY,AAAQ,QAAA;AACxB,qBAAc,aAAV,SAAS;AAC8B,kBAAzC,AAAkB,iCAAS,aAAa;;AAKW,kBAAnD,qCAAwB,WAAV,SAAS,WAAM,QAAC,KAAM,aAAa;;;AAGrD,oBAAO;;;;MAIf;;AAIE,cAAc,iCAAK;MACrB;;AAME,cAAc,2BAAU,cACR,AACT,2BADc,0CACT,QAAC,WAAY,AAAQ,OAAD,OAAK,QAAC,UACZ,YAAP,MAAM,EAAI;MAG/B;0BAE4D;AACtD,yBAAiB,WAAJ,IAAI;AACT,QAAZ,cAAQ;AACR,YAAe,aAAX,UAAU;AACa,UAAzB,qCAAc,UAAU;;AAEc,UAAtC,AAAkB,oDAAS,UAAU;;MAEzC;sBAE6B;AAGqB,QAFhD,AACK,AACA,MAFC,iBACsB,UAAlB,iDACwB,UAAlB;MAClB;;;MAnHM,0BAAoB;MAIpB,wBAAkB;MAGlB,4BAA8B;MAG9B,6BAAqC;MAGtC,gBAAU;MACV,mBAAa;MACb,cAAQ;MAgBE;;IAqFjB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AC7HwB,cAAA,AAAS;MAAS;;AAErB,cAAA,AAAS;MAAM;;AAEV,cAAA,AAAS;MAAM;;AAEX,cAAA,AAAS;MAAO;eAEjB;AACvB,cAAA,AAAS,wBAAS,eAAe;MAAC;;AAErB,cAAA,AAAS;MAAQ;YAEhB;AAAsB,cAAA,AAAS,qBAAM,iBAAiB;MAAC;;;;IAC3E","file":"async_action.ddc.js"}');
  // Exports:
  return {
