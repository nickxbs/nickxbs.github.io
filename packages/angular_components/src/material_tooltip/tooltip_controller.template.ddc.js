define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/src/material_tooltip/tooltip_controller', 'packages/angular/angular.template'], (function load__packages__angular_components__src__material_tooltip__tooltip_controller_template(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular_components__src__material_tooltip__tooltip_controller, packages__angular__angular$46template) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["tooltip_controller.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,yCAAW;AAEyD,IAApE,0BAAuB,qCAAmB,cAAM;AAC3B,IAArB;EACF;;MATI,sCAAQ;YAAG","file":"tooltip_controller.template.ddc.js"}');
  // Exports:
  return {
