define(['dart_sdk', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular_components/utils/angular/scroll_host/interface', 'packages/logging/logging', 'packages/angular_components/utils/browser/events/events', 'packages/quiver/core'], (function load__packages__angular_components__src__utils__angular__scroll_host__pan_controller_impl(dart_sdk, packages__angular_components__src__utils__angular__scroll_host__scroll_host_interface, packages__angular_components__utils__browser__dom_service__dom_service, packages__angular_components__src__utils__async__async_update_scheduler, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__disposer__disposer, packages__angular_components__utils__browser__feature_detector__feature_detector, packages__angular_components__utils__angular__scroll_host__interface, packages__logging__logging, packages__angular_components__utils__browser__events__events, packages__quiver__core) {
  ...
  var StreamControllerOfNullN = () => (StreamControllerOfNullN = dart.constFn(async.StreamController$(core.Null)))();
  ...
  var WheelEventLToNullN = () => (WheelEventLToNullN = dart.constFn(dart.fnType(core.Null, [WheelEventL()])))();
  ...
  var ScrollHostEventLToNullN = () => (ScrollHostEventLToNullN = dart.constFn(dart.fnType(core.Null, [ScrollHostEventL()])))();
  ...
  var PanEventLToNullN = () => (PanEventLToNullN = dart.constFn(dart.fnType(core.Null, [PanEventL()])))();
  ...
  var IntersectionObserverEntryLToNullN = () => (IntersectionObserverEntryLToNullN = dart.constFn(dart.fnType(core.Null, [IntersectionObserverEntryL()])))();
  ...
  var L1 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart";
  var L4 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/utils/angular/scroll_host/scroll_host_base.dart";
  var L2 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/utils/angular/scroll_host/pan_controller_impl.dart";
  var L7 = "package:angular_components/src/utils/angular/scroll_host/position_sticky_controller.dart";
  var L6 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/utils/angular/scroll_host/position_sticky_controller.dart";
  ...
  sticky_controller_impl.StickyControllerImpl = class StickyControllerImpl extends core.Object {
    ...
    get onUpdate() {
      this[_onUpdateController] == null ? this[_onUpdateController] = StreamControllerOfNullN().broadcast({sync: true}) : null;
  ...
  (sticky_controller_impl.StickyControllerImpl.new = function(_domService, _scrollHost) {
    ...
    this[_floatingElements] = new (_HashSetOfElementL()).new();
    this[_orderedRows] = null;
  ...
  dart.setFieldSignature(sticky_controller_impl.StickyControllerImpl, () => ({
    ...
    [_floatingElements]: dart.fieldType(dart.legacy(core.Set$(dart.legacy(html.Element)))),
  ...
  sticky_controller_impl.StickyRowUtils = class StickyRowUtils extends core.Object {
    ...
    static calculateLayout(T, hostPosition, rows, opts) {
      ...
      for (let i = 0; i < dart.notNull(rows[$length]); i = i + 1) {
        ...
        let hasStuckDuplicate = dart.test(shouldStick) && row.stickyKey != null && dart.equals((t0$ = stickyKeyToRowIndex, t0$ == null ? null : dart.dsend(t0$, 'containsKey', [row.stickyKey])), true);
        if (hasStuckDuplicate && dart.test(row.isTop)) {
          let duplicateRow = layout.topRows[$_get](core.int.as(dart.dsend(stickyKeyToRowIndex, '_get', [row.stickyKey])));
        ...
        if (dart.test(shouldStick) && !hasStuckDuplicate) {
          if (dart.test(row.isTop)) {
            ...
            if (row.stickyKey != null) {
              ...
              dart.dsend(stickyKeyToRowIndex, '_set', [row.stickyKey, dart.notNull(layout.topRows[$length]) - 1]);
            }
          } else {
            if (!dart.test(row.isBottom)) dart.assertFailed(null, L1, 528, 18, "row.isBottom");
            if (layout.bottomRows == null) {
            ...
            if (row.stickyKey != null) {
              stickyKeyToRowIndex == null ? stickyKeyToRowIndex = new (IdentityMapOfStringL$intL()).new() : null;
              dart.dsend(stickyKeyToRowIndex, '_set', [row.stickyKey, dart.notNull(layout.bottomRows[$length]) - 1]);
            }
          }
        } else {
          if (layout.hiddenRows == null) {
          ...
          if (shouldReplace) {
            let duplicateRow = layout.topRows[$_get](core.int.as(dart.dsend(stickyKeyToRowIndex, '_get', [row.stickyKey]))).row;
            layout.hiddenRows[$add](duplicateRow);
            layout.topRows[$_set](core.int.as(dart.dsend(stickyKeyToRowIndex, '_get', [row.stickyKey])), new (sticky_controller_impl._RowData$(dart.legacy(T))).new(row, {offsetY: 0}));
        ...
        if (dart.test(enableSmoothPushing) && !dart.test(shouldStick) && hasStuckDuplicate && dart.test(row.isTop)) {
          let duplicateRowIdx = dart.dsend(stickyKeyToRowIndex, '_get', [row.stickyKey]);
          let duplicateRow = layout.topRows[$_get](core.int.as(duplicateRowIdx));
  ...
  scroll_host_base.ScrollHostBase = class ScrollHostBase extends core.Object {
    ...
    [_startElementListeners]() {
      ...
      if (!dart.test(this.usePositionSticky)) {
        this[_elementListenersDisposer].addStreamSubscription(WheelEventL(), this.anchorElement[$onWheel].listen(dart.fn(event => {
          ...
          if (dart.test((t0$ = (t0 = event, t0 == null ? null : t0.ctrlKey), t0$ == null ? false : t0$)) || dart.test((t0$1 = (t0$0 = event, t0$0 == null ? null : t0$0.shiftKey), t0$1 == null ? false : t0$1))) return;
          let deltaX = null;
          let deltaY = null;
          try {
            deltaX = event[$deltaX];
    ...
    onIntersection(element) {
      let t4, t3;
      if (!dart.test(feature_detector.supportsIntersectionObserver)) dart.assertFailed(null, L4, 286, 12, "feature_detector.supportsIntersectionObserver");
  ...
  (scroll_host_base.ScrollHostBase.new = function(_domService, _ngZone, gestureListenerFactory, opts) {
    ...
    if (dart.test(feature_detector.isTouchInterface)) {
  ...
  (scroll_host_base.ElementScrollHostBase.new = function(domService, managedZone, gestureListenerFactory, element, opts) {
    let usePositionSticky = opts && 'usePositionSticky' in opts ? opts.usePositionSticky : false;
    this[element$] = element;
    scroll_host_base.ElementScrollHostBase.__proto__.new.call(this, domService, managedZone, gestureListenerFactory, {usePositionSticky: usePositionSticky});
  ...
  scroll_host_base.BasePanClassDirective = class BasePanClassDirective extends core.Object {
    set className(value) {
      if (!(this[_className] == null || this[_className] == value)) dart.assertFailed(null, L4, 431, 12, "(_className == null) || (_className == value)");
  ...
  dart.setMethodSignature(scroll_host_base.BasePanClassDirective, () => ({
    ...
    [_updateClass]: dart.fnType(dart.dynamic, [dart.legacy(core.bool), dart.legacy(core.bool), dart.legacy(core.String)])
  }));
  ...
  position_sticky_controller.PositionStickyController = class PositionStickyController extends core.Object {
    ...
    [_startIntersectionSubscription](stickyElement) {
      ...
      }, IntersectionObserverEntryLToNullN()));
    }
