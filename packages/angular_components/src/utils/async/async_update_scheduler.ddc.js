define(['dart_sdk', 'packages/collection/src/priority_queue', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/rate_limit_utils/rate_limit_utils'], (function load__packages__angular_components__src__utils__async__async_update_scheduler(dart_sdk, packages__collection__src__priority_queue, packages__angular_components__utils__disposer__disposer, packages__angular_components__utils__rate_limit_utils__rate_limit_utils) {
  ...
  var SimpleStreamSubscriptionOfNullN = () => (SimpleStreamSubscriptionOfNullN = dart.constFn(simple_stream.SimpleStreamSubscription$(core.Null)))();
  var SimpleStreamSubscriptionLOfNullN = () => (SimpleStreamSubscriptionLOfNullN = dart.constFn(dart.legacy(SimpleStreamSubscriptionOfNullN())))();
  ...
  var L1 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/src/utils/async/simple_stream.dart";
  var L7 = "package:angular_components/src/utils/async/zoned_async.dart";
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.constList([], SimpleStreamSubscriptionLOfNullN());
    },
    get C1() {
  ...
  dart.setGetterSignature(async_update_scheduler.AsyncUpdateScheduler, () => ({
    ...
    onUpdate: dart.legacy(async.Stream)
  }));
  ...
  dart.setFieldSignature(async_update_scheduler.AsyncUpdateScheduler, () => ({
    ...
    [_onUpdateStreamController]: dart.fieldType(dart.legacy(async.StreamController))
  }));
    ...
    class SimpleStream extends async.Stream$(dart.legacy(T)) {
      ...
      [_cleanUp]() {
        ...
        if (dart.test(this.hasListener)) {
          ...
          if (!dart.test(listeners[$isNotEmpty])) dart.assertFailed(null, L1, 131, 14, "listeners.isNotEmpty");
      ...
      addError(errorEvent, stackTrace = null) {
        ...
        for (let i = 0; i < dart.notNull(len); i = i + 1) {
          ...
          if (callback != null) {
            if (dynamicAnddynamicToLdynamic().is(callback)) {
              callback(errorEvent, stackTrace);
            } else if (dynamicToLdynamic().is(callback)) {
              callback(errorEvent);
            }
          }
        }
      ...
      listen(onData, opts) {
        ...
        if (!(this[_subscriptions] != null)) dart.assertFailed(null, L1, 251, 12, "_subscriptions != null");
