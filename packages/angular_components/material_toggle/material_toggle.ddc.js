define(['dart_sdk', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_forms/src/directives'], (function load__packages__angular_components__material_toggle__material_toggle(dart_sdk, packages__angular_components__utils__browser__events__events, packages__angular__src__core__change_detection__change_detection, packages__angular_components__interfaces__has_disabled, packages__angular_forms__src__directives) {
  'use strict';
