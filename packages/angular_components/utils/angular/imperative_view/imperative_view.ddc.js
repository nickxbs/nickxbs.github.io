define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/disposer/disposer'], (function load__packages__angular_components__utils__angular__imperative_view__imperative_view(dart_sdk, packages__angular__src__bootstrap__modules, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__browser__dom_service__dom_service, packages__angular_components__utils__disposer__disposer) {
  ...
  var dynamicToImperativeViewRefL = () => (dynamicToImperativeViewRefL = dart.constFn(dart.fnType(ImperativeViewRefL(), [dart.dynamic])))();
  ...
  imperative_view.AcxImperativeViewUtils = class AcxImperativeViewUtils extends core.Object {
    insertComponent(componentFactory, viewContainer, intoDomElement, opts) {
      ...
      return async.async(ComponentRefL(), (function* insertComponent() {
        let t0;
        let ref = this[_componentLoader$].loadNextToLocation(dart.dynamic, componentFactory, viewContainer, {injector: (t0 = injector, t0 == null ? viewContainer.parentInjector : t0)});
  ...
  dart.setMethodSignature(imperative_view.AcxImperativeViewUtils, () => ({
    ...
    insertComponent: dart.fnType(dart.legacy(async.Future$(dart.legacy(component_factory.ComponentRef))), [dart.legacy(component_factory.ComponentFactory), dart.legacy(view_container_ref.ViewContainerRef), dart.legacy(html.HtmlElement)], {injector: dart.legacy(injector.Injector)}, {}),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["imperative_view.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;oBAsEwD,kBACjC,eAA2B;UAClC;AAFsB;;AAGrB,kBAAM,AAAiB,yDAChC,gBAAgB,EAAE,aAAa,cACZ,KAAT,QAAQ,QAAR,OAAY,AAAc,aAAD;AACZ,QAA3B,MAAM,AAAY;AACiB,QAAnC,AAAe,cAAD,UAAQ,AAAI,GAAD;AACzB,cAAO,IAAG;MACZ;;sBAQwD,gBACxC,aAA8B;AAC5C,YAAO,AAAY,AAAU,yDAAK,QAAC;AAC7B,sBAAU,AAAc,aAAD,oBAAoB,WAAW;AAC1D,iBAAW,WAAY,AAAQ,QAAD;AACG,UAA/B,AAAe,cAAD,UAAQ,QAAQ;;AAEhC,cAAyB,0CAAE,OAAO,EAAE;AAC9B,sBAAQ,AAAc,aAAD,SAAS,OAAO;AACzC,cAAU,aAAN,KAAK,IAAG,CAAC,GAAG,AAAc,AAAa,aAAd,QAAQ,KAAK;;;IAGhD;;yDAjC4B,kBAAuB;IAAvB;IAAuB;;EAAY;;;;;;;;;;;;;;;;;IAuCzC;;;;;;;AAMR,MAAZ,AAAU;IACZ;;mDALyB,SAAc;IAAd;IAAc;;EAAW","file":"imperative_view.ddc.js"}');
  // Exports:
  return {
