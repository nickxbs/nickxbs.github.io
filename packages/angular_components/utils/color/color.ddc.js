define(['dart_sdk', 'packages/quiver/core'], (function load__packages__angular_components__utils__color__color(dart_sdk, packages__quiver__core) {
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/utils/color/color.dart";
  ...
  color$.Color = class Color extends core.Object {
    ...
    withAlpha(a) {
      if (!(dart.notNull(a) >= 0 && dart.notNull(a) <= 1)) dart.assertFailed(null, L0, 181, 12, "a >= 0 && a <= 1");
