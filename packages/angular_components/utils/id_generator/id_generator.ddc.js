define(['dart_sdk'], (function load__packages__angular_components__utils__id_generator__id_generator(dart_sdk) {
  ...
  id_generator.SequentialIdGenerator = class SequentialIdGenerator extends core.Object {
    ...
    static _createUuid() {
      ...
      return dart.str(chars[$substring](0, 8)) + "-" + dart.str(chars[$substring](8, 12)) + "-" + dart.str(chars[$substring](12, 16)) + "-" + dart.str(chars[$substring](16, 20)) + "-" + dart.str(chars[$substring](20, 32));
    }
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["id_generator.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;EAUA;;;;;;;;;AA2BqB,YAAqB,UAAnB,kBAAO,iBAAQ,iBAAJ,gCAAI;IAAI;;AAQlC,kBAAQ,sBAAmB,IAAI,QAAC,KAAM,AAAK,gDAAQ;AACpB,MAAnC,AAAK,KAAA,QAAC,GAAe,AAAQ,aAAjB,AAAK,KAAA,QAAC,MAAK,KAAQ;AACI,MAAnC,AAAK,KAAA,QAAC,GAAe,AAAQ,aAAjB,AAAK,KAAA,QAAC,MAAK,KAAQ;AAE3B,kBAAQ,AACP,AACA,AACA,KAHY,kBACR,QAAC,KAAM,AAAE,AAAkB,CAAnB,iBAAe,cAAY,GAAG;AAI/C,sBAAU,AAAM,KAAD,aAAW,GAAG,MAAG,eAAG,AAAM,KAAD,aAAW,GAAG,OAAI,eACnD,AAAM,KAAD,aAAW,IAAI,OAAI,eAAG,AAAM,KAAD,aAAW,IAAI,OAAI,eACnD,AAAM,KAAD,aAAW,IAAI;IAC7B;;qDAhC2B;IARvB,aAAO;IAQgB;;EAAQ;;sDASK;EAAc;;;;;;;;;;;;;;;MAnBzC,uCAAI;YAAQ","file":"id_generator.ddc.js"}');
  // Exports:
  return {
