define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/utils/browser/feature_detector/feature_detector'], (function load__packages__angular_components__utils__browser__events__events(dart_sdk, packages__angular__src__bootstrap__modules, packages__angular_components__utils__browser__feature_detector__feature_detector) {
  ...
  var ListLAndResizeObserverLToNullN = () => (ListLAndResizeObserverLToNullN = dart.constFn(dart.fnType(core.Null, [ListL(), ResizeObserverL()])))();
  var ObjectL = () => (ObjectL = dart.constFn(dart.legacy(core.Object)))();
  var JSArrayOfObjectL = () => (JSArrayOfObjectL = dart.constFn(_interceptors.JSArray$(ObjectL())))();
  var intL = () => (intL = dart.constFn(dart.legacy(core.int)))();
  const CT = Object.create(null);
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/utils/browser/events/events.dart";
  ...
  events.triggersOutsideAny = function triggersOutsideAny(checkNodeInside) {
    ...
    let listener = null;
    if (events.enableNewTriggerLogic == null) {
      events.enableNewTriggerLogic == null ? events.enableNewTriggerLogic = true : null;
    }
    controller = StreamControllerOfEventL().broadcast({sync: true, onListen: dart.fn(() => {
        if (!(clickListener == null)) dart.assertFailed(null, L0, 76, 16, "clickListener == null");
        if (!(mouseDownListener == null)) dart.assertFailed(null, L0, 77, 16, "mouseDownListener == null");
        if (!(mouseUpListener == null)) dart.assertFailed(null, L0, 78, 16, "mouseUpListener == null");
        let lastEvent = null;
        ...
        if (dart.test(events.enableNewTriggerLogic)) {
  ...
  events.onResize = function onResize(element) {
    if (!dart.test(feature_detector.supportsResizeObserver)) dart.assertFailed("ResizeObserver support is required", L0, 169, 10, "supportsResizeObserver");
    let controller = null;
    let observer = null;
    controller = StreamControllerOfRectangleLOfnum().broadcast({sync: true, onListen: dart.fn(() => {
        ...
        }, ListLAndResizeObserverLToNullN())));
  ...
  dart.defineLazy(events, {
    /*events.enableNewTriggerLogic*/get enableNewTriggerLogic() {
      return null;
    },
  ...
  }, '{"version":3,"sourceRoot":"","sources":["events.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0CAmB8B;AAE5B,UAAO,AAAM,AAAQ,MAAT,aAAY,IAAI,AAAM,AAAQ,KAAT,kBAA4B,AAAM,AAAI,KAAL,SAAQ;EAC5E;wDAEqC;AACjC,UAAA,AAAM,AAAQ,AAAiB,MAA1B,6BAA6B,kBAAW,KAAK;EAAC;8DAIlB;AACjC,UAAA,AAAM,AAAO,AAGE,MAHV,YAAW,gBACf,AAAM,KAAD,uBACL,AAAM,KAAD,wBACL,AAAM,KAAD,wBACL,AAAM,KAAD;EAAS;kEAGiB;AAClC,UAAa,AAA6C,kBAAnD,KAAK,eAAkB,4BAAqB,KAAK,MAC9C,oBAAN,KAAK,eAAqB,yBAAkB,KAAK;EACvD;+BAIiC;AAAc,mBAAC,SAAU,WAAC,AAAS,SAAA,CAAC,KAAK;EAAC;oDAGV;AAC/D,QAAY,iBAAR,OAAO,GAAgB,AAA+B,UAAb,WAAR,OAAO;AAC5C,UAAO,2BAAmB,QAAC,QAAc,YAAL,IAAI,EAAI,OAAO;EACrD;0DAWiD;AACvB;AACO;AACA;AACA;AACjB;AAEd,QAAI,AAAsB,gCAAG;AACG,MAA9B,AAAsB,uCAAA,+BAAI,OAAJ;;AAuFlB,IApFN,aAA8B,4CACpB,gBACI;AACR,cAAO,AAAc,aAAD,IAAI;AACxB,cAAO,AAAkB,iBAAD,IAAI;AAC5B,cAAO,AAAgB,eAAD,IAAI;AAEpB;AACA;AAaL,QAXD,WAAW,QAAO;AACH,UAAb,YAAY,CAAC;AACT,qBAAgB,WAAT,AAAE,CAAD;AACZ,iBAAO,IAAI,IAAI;AACb,0BAAI,AAAe,eAAA,CAAC,IAAI;AACtB;;AAEkB,cAAlB,OAAO,AAAK,IAAD;;;AAGE,UAAjB,AAAW,UAAD,KAAK,CAAC;;AAMlB,sBAAI;AA