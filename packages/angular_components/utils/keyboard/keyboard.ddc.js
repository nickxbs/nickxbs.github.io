define(['dart_sdk'], (function load__packages__angular_components__utils__keyboard__keyboard(dart_sdk) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["keyboard.dart"],"names":[],"mappings":";;;;;;;wDAWoC;QAC1B;QACD;QACA;QACA;AACP,UAAuB,AAEQ,aAFvB,AAAM,KAAD,WAAa,QAAQ,KAChB,YAAb,AAAM,KAAD,SAAW,MAAM,KACR,YAAd,AAAM,KAAD,UAAY,OAAO,KACV,YAAd,AAAM,KAAD,UAAY,OAAO;EAC/B","file":"keyboard.ddc.js"}');
  // Exports:
  return {
