define(['dart_sdk', 'packages/async/async', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service'], (function load__packages__angular_components__utils__showhide__showhide(dart_sdk, packages__async__async, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__browser__dom_service__dom_service) {
  'use strict';
  ...
  dart.setFieldSignature(showhide.ShowHideDirective, () => ({
    ...
    [_onHide]: dart.fieldType(dart.legacy(async.StreamController$(dart.legacy(html.Element)))),
    [_onShow]: dart.fieldType(dart.legacy(async.StreamController$(dart.legacy(html.Element)))),
    [_onShowEnd]: dart.fieldType(dart.legacy(async.StreamController$(dart.legacy(html.Element)))),
    [_onHideEnd]: dart.fieldType(dart.legacy(async.StreamController$(dart.legacy(html.Element))))
  }));
