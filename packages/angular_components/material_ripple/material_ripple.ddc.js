define(['dart_sdk', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/core/change_detection/change_detection'], (function load__packages__angular_components__material_ripple__material_ripple(dart_sdk, packages__angular_components__utils__browser__feature_detector__feature_detector, packages__angular_components__utils__browser__events__events, packages__angular__src__core__change_detection__change_detection) {
  'use strict';
  ...
  var DivElementLToNullN = () => (DivElementLToNullN = dart.constFn(dart.fnType(core.Null, [DivElementL()])))();
  ...
  material_ripple._createRipple = function _createRipple(clientX, clientY, container, center) {
    ...
    if (dart.notNull(material_ripple._numRipples) < 3) {
      ...
      material_ripple._ripplePool[$_set](material_ripple._rippleIndex, DivElementL().as(ripple));
    ...
    if (dart.test(feature_detector.supportsAnimationApi)) {
      material_ripple._applyAnimation(DivElementL().as(ripple), center, rect, clientX, clientY);
    } else {
      material_ripple._applyFallbackAnimation(DivElementL().as(ripple), center, rect, clientX, clientY);
    }
    container[$append](html.Node.as(ripple));
  };
  material_ripple._applyAnimation = function _applyAnimation(ripple, center, rect, clientX, clientY) {
    ...
    let transformKeyframes = JSArrayOfMapLOfStringL$dynamic().of([new (IdentityMapOfStringL$dynamic()).from(["transform", initialTransform]), new (IdentityMapOfStringL$dynamic()).from(["transform", finalTransform])]);
  ...
  material_ripple._applyFallbackAnimation = function _applyFallbackAnimation(ripple, center, rect, clientX, clientY) {
    ...
    ripple.style[$top] = StringN().as(top);
    ripple.style[$left] = StringN().as(left);
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_ripple.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAqNO;;;;;;iBALiB,SAAa;AAC/B,2CAAc,OAAO,EAAE,OAAO,EAAE,iBAAU;IAAO;;AAQI,MAAvD,AAAS,sCAAoB,aAAa;AACS,MAAnD,AAAS,sCAAoB,WAAW;AAKtC,MAJF,AAAY,sCAAQ,QAAC;;AACnB,YAAmB,kBAAf,MAAM,eAAN,OAAQ,cAAU;AACL,UAAf,AAAO,MAAD;;;IAGZ;;0DAjE6B;;IAHf;IACA;IAwDT,eAAS;IAtDe;AAGkB,IAA7C,AAAY,sCAAA,8BAAI,6BAAJ;AAGX,IAFD,AAAe,yCAAA,iCAAI,2CACjB,YAAY,UADC;AAQd,IALD,AAAkB,4CAAA,oCAAI,qCACpB,2CAAC,gBACD,2CAAC,iBAAwB,UAAU,QACnC,2CAAC,iBAAwB,UAAU,OACnC,2CAAC,mBAJe;AASjB,IAHD,AAAiB,2CAAA,mCAAI,2CACnB,YAAY,OACZ,UAAU,qCAFK;AAMjB,QAAI,AAAgB,mCAAG;AACf,gCACD,yCAAwB,iBAAiB;AACO,MAArD,+DAAkB;AAAc,uBAAY,SAAS;;;;AAatD,IAND,qBAAe,QAAC;AAGR,oBAAa,AAAe,AAAO,iBAAxB,CAAC;AACZ,oBAAa,AAAe,AAAO,iBAAxB,CAAC;AAC+B,MAAjD,iDAAc,OAAO,sBAAE,OAAO,GAAE,iBAAU;;AAM3C,IAJD,mBAAa,QAAC;AACZ,qBAAK,6CAAkB,CAAC,KAAG;AAEQ,MAAnC,8BAAc,GAAG,GAAG,iBAAU;;AAKoB,IAApD,AAAS,mCAAiB,aAAa;AACS,IAAhD,AAAS,mCAAiB,WAAW;EACvC;;;;;;;;;;;;;;;;;yDAlKM,SAAa,SAAqB,WAAgB;AAElD,eAAO,AAAU,SAAD;AAGlB;AACJ,QAAgB,aAAZ;AACiD,MAAnD,SAAsC,iBAA7B,AAAgB,wCAAM;AACG,MAAlC,AAAW,mCAAC,+CAAgB,MAAM;AACrB,MAAb,8BAAW,aAAX,+BAAW;;AAEuB,MAAlC,SAAS,AAAW,mCAAC;AACN,MAAR,WAAP,MAAM;;AAGR,QAAmB,CAAb,+BAAF,aAAE,gCAAF,UAA+B,AAAgB,+BAAD;AAIlD,kBAAI;AACqD,MAAvD,iDAAgB,MAAM,GAAE,MAAM,EAAE,IAAI,EAAE,OAAO,EAAE,OAAO;;AAES,MAA/D,yDAAwB,MAAM,GAAE,MAAM,EAAE,IAAI,EAAE,OAAO,EAAE,OAAO;;AAExC,IAAxB,AAAU,SAAD,uBAAQ,MAAM;EACzB;6DAIe,QAAa,QAAkB,MAAU,SAAa;AAE7D,yBAAiB,AAAK,IAAD;AACrB,0BAAkB,AAAK,IAAD;AACtB,uBACc,aAAf,cAAc,iBAAG,eAAe,IAAI,cAAc,GAAG,eAAe;AACnE,mBAAyB,AAAO,aAApB,YAAY,IAAG;AAI3B,oBACF,AAA+D,UAA1D,AAA2B,SAAR,aAAf,cAAc,IAAG,GAAG,KAAK,SAAoB,aAAhB,eAAe,IAAG,GAAG,MAAM;AAC/D,mBAAW,AAAU,SAAD;AAEtB;AACA;AACA;AACA;AAEJ,kBAAI,MAAM;AAC8B,MAAtC,MAAM,AAAgC,gCAAJ;AACK,MAAvC,OAAO,AAAgC,gCAAJ;AACE,MAArC,mBAAmB,AAAkB,oBAAV,QAAQ;AACA,MAAnC,iBAAiB,AAAkB,oBAAV,QAAQ;;AAE3B,oBAAkB,AAAY,aAApB,OAAO,iBAAG,AAAK,IAAD;AACxB,oBAAkB,AAAW,aAAnB,OAAO,iBAAG,AAAK,IAAD;AAExB,mBAAyB,AAAI,AAAiB,aAApC,cAAc,IAAG,UAAqB,OAAO;AACvD,mBAA0B,AAAI,AAAiB,aAArC,eAAe,IAAG,UAAqB,OAAO;AAC1C,MAApB,MAAoB,SAAX,OAAO,IAAC;AACI,MAArB,OAAqB,SAAX,OAAO,IAAC;AACmC,MAArD,mBAAmB,AAAkC,oCAAV,QAAQ;AACoB,MAAvE,iBAAiB,AAAsD,wBAAzC,MAAM,IAAC,kBAAM,MAAM,IAAC,wBAAW,QAAQ;;AAGjE,6BAAqB,qCACzB,2CAAC,aAAa,gBAAgB,IAC9B,2CAAC,aAAa,cAAc;AAG6C,IAA3E,AAAO,AAAM,MAAP,iBAAiB,AAAoD,mBAA7C,GAAG,0BAAS,IAAI,+BAAc,cAAc;AACzB,IAAjD,AAAO,MAAD,WAAS,mCAAmB;AACkB,IAApD,AAAO,MAAD,WAAS,kBAAkB,EAAE;EACrC;6EAKe,QAAa,QAAkB,MAAU,SAAa;AAC/D;AACA;AAEJ,kBAAI,MAAM;AAC8B,MAAtC,MAAM,AAAgC,gCAAJ;AACK,MAAvC,OAAO,AAAgC,gCAAJ;;AAE7B,oBAAkB,AAAY,aAApB,OAAO,iBAAG,AAAK,IAAD;AACxB,oBAAkB,AAAW,aAAnB,OAAO,iBAAG,AAAK,IAAD;AACV,MAApB,MAAoB,SAAX,OAAO,IAAC;AACI,MAArB,OAAqB,SAAX,OAAO,IAAC;;AAGE,IAAtB,AAAO,AAAM,MAAP,eAAO,aAAM,GAAG;AACE,IAAxB,AAAO,AAAM,MAAP,gBAAO,aAAO,IAAI;EAC1B;;MAxHM,+BAAe;;;MACf,6BAAa;;;MACb,2BAAW;;;MACX,2BAAW;;;MAKX,2BAAW;;;MAIb,2BAAW;YAAG;;;MACd,4BAAY;YAAG;;;MAIF,2BAAW;;;;MACjB,+BAAe;;;;MACN,8BAAc;;;;MACR,iCAAiB;;;;MACtB,gCAAgB","file":"material_ripple.ddc.js"}');
  // Exports:
  return {
