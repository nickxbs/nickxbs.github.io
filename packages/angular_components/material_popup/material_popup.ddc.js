define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/model/ui/toggle', 'packages/angular_components/src/laminate/popup/dom_popup_source', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular_components/laminate/enums/visibility', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/content/deferred_content_aware', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/model/math/box', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/utils/id_generator/id_generator'], (function load__packages__angular_components__material_popup__material_popup(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__angular_components__src__laminate__popup__popup_hierarchy, packages__angular_components__model__ui__toggle, packages__angular_components__src__laminate__popup__dom_popup_source, packages__angular_components__src__utils__async__async_update_scheduler, packages__angular_components__laminate__enums__visibility, packages__angular_components__focus__focus_interface, packages__angular_components__laminate__enums__alignment, packages__angular_components__content__deferred_content_aware, packages__angular__src__core__change_detection__change_detection, packages__angular_components__mixins__material_dropdown_base, packages__angular__src__bootstrap__modules, packages__angular_components__src__laminate__overlay__overlay_ref, packages__angular_components__utils__browser__dom_service__dom_service, packages__angular_components__model__math__box, packages__angular_components__laminate__overlay__zindexer, packages__angular_components__utils__id_generator__id_generator) {
  ...
  var ListLOfRectangleLOfnumLToNullN = () => (ListLOfRectangleLOfnumLToNullN = dart.constFn(dart.fnType(core.Null, [ListLOfRectangleLOfnumL()])))();
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/material_popup/material_popup.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  material_popup.MaterialPopupComponent = class MaterialPopupComponent extends Object_PopupHierarchyElement$36 {
    ...
    [_initView]() {
      if (!dart.equals(this[_viewInitialized], false)) dart.assertFailed(null, L0, 318, 12, "_viewInitialized == false");
    ...
    [_open]() {
      ...
      let popupContentsLayoutStream = this[_overlayRef].measureSizeChanges().asBroadcastStream({onCancel: dart.gbind(dart.bind(this[_visibleDisposer], 'addStreamSubscription'), RectangleLOfnumL())});
      ...
      }, ListLOfRectangleLOfnumLToNullN())));
    ...
    [_getBestPosition](contentRect, sourceRect, containerRect) {
      if (!dart.test(this.state.enforceSpaceConstraints)) dart.assertFailed(null, L0, 699, 12, "state.enforceSpaceConstraints");
