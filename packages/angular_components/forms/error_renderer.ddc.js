define(['dart_sdk'], (function load__packages__angular_components__forms__error_renderer(dart_sdk) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["error_renderer.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;wDAU0C;AACtC,mBAAC,UAAW,kCAAmB,SAAS,EAAE,MAAM;EAAC;kEAG7B,WAAgC;AAChD,iBAAS,sCAA0B,MAAM;AAC/C,aAAS,QAAS,AAAO,OAAD;AACtB,oBAAI,AAAU,SAAD,eAAa,KAAK,IAAG,AAAM,AAA0B,MAA1B,QAAC,KAAK,EAAI,AAAS,SAAA,QAAC,KAAK;;AAEnE,UAAO,OAAM;EACf","file":"error_renderer.ddc.js"}');
  // Exports:
  return {
