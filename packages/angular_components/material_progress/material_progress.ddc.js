define(['dart_sdk', 'packages/intl/intl', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular/src/core/change_detection/change_detection'], (function load__packages__angular_components__material_progress__material_progress(dart_sdk, packages__intl__intl, packages__angular_components__utils__browser__feature_detector__feature_detector, packages__angular__src__core__change_detection__change_detection) {
  'use strict';
  ...
  dart.setFieldSignature(material_progress.MaterialProgressComponent, () => ({
    ...
    [_loadingValue]: dart.fieldType(dart.legacy(core.String)),
