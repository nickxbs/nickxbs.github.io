define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/intl/intl', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/src/time/clock', 'packages/angular_components/src/model/selection/interfaces/selectable', 'packages/angular_components/model/selection/string_selection_options'], (function load__packages__angular_components__material_datepicker__material_time_picker(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__intl__intl, packages__angular_components__model__selection__selection_model, packages__angular_components__model__a11y__keyboard_handler_mixin, packages__angular_components__interfaces__has_disabled, packages__angular__src__core__change_detection__change_detection, packages__quiver__src__time__clock, packages__angular_components__src__model__selection__interfaces__selectable, packages__angular_components__model__selection__string_selection_options) {
  ...
  var ListLOfSelectionChangeRecordLOfDateTimeLToNullN = () => (ListLOfSelectionChangeRecordLOfDateTimeLToNullN = dart.constFn(dart.fnType(core.Null, [ListLOfSelectionChangeRecordLOfDateTimeL()])))();
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(material_time_picker.MaterialTimePickerComponent._localTime, intLAndintLToDateTimeL());
    },
    get C1() {
      return C1 = dart.fn(material_time_picker.MaterialTimePickerComponent._utcTime, intLAndintLToDateTimeL());
    },
    get C2() {
  ...
  var _disabled = dart.privateName(material_time_picker, "_disabled");
  var _required = dart.privateName(material_time_picker, "_required");
  ...
  material_time_picker.MaterialTimePickerComponent = class MaterialTimePickerComponent extends keyboard_handler_mixin.KeyboardHandlerMixin {
    ...
    set utc(value) {
      this[_utc] = value;
      this.timeOptions = new material_time_picker.TimeSelectionOptions.new(ListOfDateTimeL().generate(24, dart.test(this[_utc]) ? C1 || CT.C1 : C0 || CT.C0));
    ...
    ngOnInit() {
      ...
      }, ListLOfSelectionChangeRecordLOfDateTimeLToNullN())));
    }
    setTimeToNowIfUnset() {
    ...
    [_parseTime](timeText) {
      ...
      formatsToParse[$addAll](material_time_picker.MaterialTimePickerComponent._supportedTimeFormats[$where](dart.fn(f => !dart.equals(this.outputFormat.pattern, f.pattern), DateFormatLToboolL())));
  ...
  (material_time_picker.MaterialTimePickerComponent.new = function(_clock) {
    ...
    this.timeOptions = new material_time_picker.TimeSelectionOptions.new(ListOfDateTimeL().generate(24, C0 || CT.C0));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_time_picker.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA+DO;;;;;;IACE;;;;;;IAMI;;;;;;IA2BJ;;;;;;IA6Fc;;;;;;IACI;;;;;;IAClB;;;;;;oBA1JsB,MAAW;AAAgB,YAAS,uBAC7D,AAAW,kEAAM,AAAW,mEAAO,AAAW,iEAAK,IAAI,EAAE,MAAM;IAAC;sBAErC,MAAW;AACtC,mCAAS,AAAW,kEAAM,AAAW,mEAAO,AAAW,iEAAK,IAAI,EAAE,MAAM;IAAC;0BAErC;AACtC,UAAI,AAAM,KAAD,IAAI,MAAM,MAAO;AAC1B,uBAAO,AAAM,KAAD,UACN,0DAAS,AAAM,KAAD,OAAO,AAAM,KAAD,WAC1B,4DAAW,AAAM,KAAD,OAAO,AAAM,KAAD;IACpC;aA2BkB;;AAC+B,