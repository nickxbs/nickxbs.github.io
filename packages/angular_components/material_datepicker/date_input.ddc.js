define(['dart_sdk', 'packages/intl/intl', 'packages/angular_components/model/date/date', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/material_datepicker/calendar', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/src/time/clock', 'packages/angular_components/material_input/material_input'], (function load__packages__angular_components__material_datepicker__date_input(dart_sdk, packages__intl__intl, packages__angular_components__model__date__date, packages__angular_components__utils__disposer__disposer, packages__angular_components__material_datepicker__calendar, packages__angular__src__core__change_detection__change_detection, packages__quiver__src__time__clock, packages__angular_components__material_input__material_input) {
  'use strict';
  ...
  date_input.DateInputDirective = class DateInputDirective extends core.Object {
    ...
    [_parseDateUsingFormatList](input, formatList) {
      ...
      formatList[$any](dart.fn(format => {
        try {
          date = date$.Date.parseLoose(input, format);
    ...
    [_parseDate](input, opts) {
      ...
      if (input[$trim]()[$isEmpty]) {
        ...
        if (dart.test(this.isMonthInput)) {
          this[_lastParse] = (t2$ = (t2 = this[_parseDateUsingFormatList](input, this[_inputFormats]), t2 == null ? this[_parseDateUsingFormatList](input, this[_monthInputFormatsWithoutDay]) : t2), t2$ == null ? this[_guessYear](this[_parseDateUsingFormatList](input, this[_monthInputFormatsMonthOnly])) : t2$);
        } else {
          this[_lastParse] = (t2$0 = this[_parseDateUsingFormatList](input, this[_inputFormats]), t2$0 == null ? this[_guessYear](this[_parseDateUsingFormatList](input, this[_dayInputFormatsWithoutYear])) : t2$0);
        }
