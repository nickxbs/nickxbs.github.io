define(['dart_sdk', 'packages/angular_components/model/observable/observable', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/date/date', 'packages/angular_components/src/material_datepicker/calendar_listener', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl'], (function load__packages__angular_components__material_datepicker__material_calendar_picker(dart_sdk, packages__angular_components__model__observable__observable, packages__angular_components__material_datepicker__calendar, packages__angular_components__model__date__date, packages__angular_components__src__material_datepicker__calendar_listener, packages__angular_components__utils__browser__feature_detector__feature_detector, packages__angular__src__core__change_detection__change_detection, packages__intl__intl) {
  'use strict';
  ...
  material_calendar_picker.MaterialCalendarPickerComponent = class MaterialCalendarPickerComponent extends core.Object {
    ...
    static _createMonthTemplate() {
      ...
      for (let i = 0; i < 6 * 7; i = i + 1) {
        ...
        container[$append](html.Node.as(slot));
      }
      return template;
    }
    set state(state) {
    ...
    [_monthAtOffset](offset) {
      let month = null;
      let total = 0;
      for (let t0 = month = this[_minMonth].copy(); total < dart.notNull(offset) && dart.dtest(dart.dsend(month, '<', [this[_maxMonth]])); dart.dsend(month, 'next', [])) {
        total = total + dart.notNull(this[_monthHeight](_MonthL().as(month)));
      }
      let previousMonthVisiblePx = total - dart.notNull(offset);
      if (previousMonthVisiblePx / dart.notNull(this[_monthHeight](_MonthL().as(dart.dsend(month, 'add', [-1])))) > 0.5) {
        dart.dsend(month, 'prev', []);
      }
      return _MonthL().as(month);
    }
    [_canSelectDate](date) {
    ...
    [_renderVisible]() {
      ...
      if (dart.test(this[_renderedMonths][$isEmpty])) {
        ...
        offset = this[_rangeHeight](this[_minMonth], _MonthL().as(dart.dsend(baseline, 'add', [-2])));
      } else {
        ...
        if (dart.notNull(offset) >= dart.notNull(this[_scrollTop])) {
          ...
          while (dart.notNull(offset) >= dart.notNull(this[_scrollTop]) && dart.dtest(dart.dsend(baseline, '>=', [this[_minMonth]]))) {
            ...
            offset = dart.notNull(offset) - dart.notNull(this[_monthHeight](_MonthL().as(baseline)));
          }
        }
        for (let t1 = baseline == null ? baseline = this[_renderedMonths][$_get](2).copy() : null; dart.notNull(offset) < dart.notNull(this[_scrollTop]) && dart.dtest(dart.dsend(baseline, '<', [this[_maxMonth]])); dart.dsend(baseline, 'next', [])) {
          offset = dart.notNull(offset) + dart.notNull(this[_monthHeight](_MonthL().as(baseline)));
        }
        let previousMonthVisiblePx = dart.notNull(offset) - dart.notNull(this[_scrollTop]);
        let previousMonthHeight = this[_monthHeight](_MonthL().as(dart.dsend(baseline, 'add', [-1])));
        ...
        offset = dart.notNull(offset) + dart.notNull(this[_rangeHeight](_MonthL().as(baseline), _MonthL().as(dart.dsend(baseline, 'add', [-2]))));
      }
      let visibleMonths = this[_monthsSurrounding](_MonthL().as(baseline));
      ...
      this[_renderToday]();
      this[_renderHover]();
      this[_visibleMonthController].add(DateL().as(dart.dload(baseline, 'start')));
    }
    [_slotSelector](date) {
    ...
    [_ensureSelectionIsVisible]() {
      ...
      let currentSelection = this.state.selections[$firstWhere](dart.fn(s => s.id == this.state.currentSelection, CalendarSelectionLToboolL()), {orElse: dart.fn(() => null, VoidToNullN())});
  ...
  (material_calendar_picker.MaterialCalendarPickerComponent.new = function(clock, legacyClock, mode) {
    ...
    if (mode != null && mode[$isNotEmpty]) {
      this[_mode] = CalendarSelectionModeL().as(enum_parsing.fuzzyParseEnum(calendar.CalendarSelectionMode.values, mode));
    }
  ...
  dart.setFieldSignature(material_calendar_picker.MaterialCalendarPickerComponent, () => ({
    ...
    [_model]: dart.fieldType(dart.legacy(observable.ObservableReference$(dart.legacy(calendar.CalendarState)))),
    ...
    [_renderedOffsets]: dart.fieldType(dart.legacy(core.List$(dart.legacy(core.int)))),
