define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/model/observable/observable', 'packages/angular_components/material_datepicker/calendar', 'packages/intl/intl', 'packages/angular/src/core/change_detection/change_detection'], (function load__packages__angular_components__material_datepicker__date_range_input(dart_sdk, packages__angular_components__model__date__date, packages__angular_components__model__observable__observable, packages__angular_components__material_datepicker__calendar, packages__intl__intl, packages__angular__src__core__change_detection__change_detection) {
  ...
  var _disabled = dart.privateName(date_range_input, "_disabled");
