define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/proto/date_range.pb', 'packages/quiver/src/time/clock', 'packages/intl/intl', 'packages/angular_components/material_datepicker/proto/date.pb'], (function load__packages__angular_components__material_datepicker__range(dart_sdk, packages__angular_components__model__date__date, packages__angular_components__material_datepicker__proto__date_range$46pb, packages__quiver__src__time__clock, packages__intl__intl, packages__angular_components__material_datepicker__proto__date$46pb) {
  ...
  var L1 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/material_datepicker/range.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  range$._ClampedDateRange = class _ClampedDateRange extends core.Object {
    ...
    toProtoBuf() {
      ...
      return (() => {
        t0.dateRange = DateRangeL().as(range$._makeDateRangeProto(this.start, this.end));
        return t0;
      })();
    }
    _equals(o) {
  ...
  range$.SingleDayRange = class SingleDayRange extends core.Object {
    ...
    static _defaultTitle(daysAgo) {
      return StringL().as(dart.notNull(daysAgo) > 0 ? range$.SingleDayRange._addDaysMsg(daysAgo) : range$.SingleDayRange._daysFromNowMsg(-dart.notNull(daysAgo)));
    }
    static _addDaysMsg(daysAgo) {
      return intl.Intl.plural(intL().as(daysAgo), {zero: "Today", one: "Yesterday", other: dart.str(daysAgo) + " days ago", name: "_addDaysMsg", args: JSArrayOfObjectL().of([daysAgo]), desc: "A date range containing only one day a certain number " + "of days in the past.", examples: C3 || CT.C3});
    }
    static _daysFromNowMsg(daysFromNow) {
      return intl.Intl.plural(intL().as(daysFromNow), {zero: "Today", one: "Tomorrow", other: dart.str(daysFromNow) + " days from now", name: "_daysFromNowMsg", args: JSArrayOfObjectL().of([daysFromNow]), desc: "A date range containing only one day a certain number " + "of days in the future.", examples: C4 || CT.C4});
    }
  };
  ...
  range$.LastNDaysRange = class LastNDaysRange extends range$.MultipleDaysRange {
    ...
    static _lastNDaysMsg(lengthInDays) {
      return intl.Intl.plural(intL().as(lengthInDays), {one: "Yesterday", other: "Last " + dart.str(lengthInDays) + " days", name: "_lastNDaysMsg", args: JSArrayOfObjectL().of([lengthInDays]), desc: "A date range containing the last \"lengthInDays\" days, " + "not including today.", examples: C5 || CT.C5});
    }
  };
  (range$.LastNDaysRange.new = function(start, lengthInDays, title = null) {
    let t0;
    range$.LastNDaysRange.__proto__.new.call(this, start, lengthInDays, StringL().as((t0 = title, t0 == null ? range$.LastNDaysRange._lastNDaysMsg(lengthInDays) : t0)));
    ;
  }).prototype = range$.LastNDaysRange.prototype;
  (range$.LastNDaysRange.beforeToday = function(clock, lengthInDays, title = null) {
    let t0;
    range$.LastNDaysRange.__proto__.new.call(this, date$.Date.today(ClockL().as(clock)).add({days: intL().as(dart.dsend(lengthInDays, '_negate', []))}), intL().as(lengthInDays), StringL().as((t0 = title, t0 == null ? range$.LastNDaysRange._lastNDaysMsg(lengthInDays) : t0)));
    ;
  }).prototype = range$.LastNDaysRange.prototype;
  ...
  range$.LastNDaysToTodayRange = class LastNDaysToTodayRange extends range$.MultipleDaysRange {
    ...
    static _lastNDaysToTodayMsg(lengthInDays) {
      return intl.Intl.plural(intL().as(lengthInDays), {one: "Today", other: dart.str(lengthInDays) + " days to today", name: "_lastNDaysToTodayMsg", args: JSArrayOfObjectL().of([lengthInDays]), desc: "A date range containing the last \"lengthInDays\" days, " + "ending today.", examples: C5 || CT.C5});
    }
  };
  (range$.LastNDaysToTodayRange.new = function(start, lengthInDays, title = null) {
    let t0;
    range$.LastNDaysToTodayRange.__proto__.new.call(this, start, lengthInDays, StringL().as((t0 = title, t0 == null ? range$.LastNDaysToTodayRange._lastNDaysToTodayMsg(lengthInDays) : t0)));
    ;
  ...
  (range$.LastNDaysToTodayRange.beforeToday = function(clock, lengthInDays, title = null) {
    let t0;
    range$.LastNDaysToTodayRange.__proto__.new.call(this, date$.Date.today(ClockL().as(clock)).add({days: intL().as(dart.dsend(dart.dsend(lengthInDays, '-', [1]), '_negate', []))}), intL().as(lengthInDays), StringL().as((t0 = title, t0 == null ? range$.LastNDaysToTodayRange._lastNDaysToTodayMsg(lengthInDays) : t0)));
    ;
  }).prototype = range$.LastNDaysToTodayRange.prototype;
  ...
  range$.NextNDaysFromTodayRange = class NextNDaysFromTodayRange extends range$.MultipleDaysRange {
    ...
    static _nextNDaysFromTodayMsg(lengthInDays) {
      return intl.Intl.plural(intL().as(lengthInDays), {one: "Today", other: dart.str(lengthInDays) + " days from today", name: "_nextNDaysFromTodayMsg", args: JSArrayOfObjectL().of([lengthInDays]), desc: "A date range containing the next \"lengthInDays\" days, " + "starting with today. [REL_NOTE:brockschmid/01-01-2019]", examples: C5 || CT.C5});
    }
  };
  (range$.NextNDaysFromTodayRange.new = function(start, lengthInDays, title = null) {
    let t0;
    range$.NextNDaysFromTodayRange.__proto__.new.call(this, start, lengthInDays, StringL().as((t0 = title, t0 == null ? range$.NextNDaysFromTodayRange._nextNDaysFromTodayMsg(lengthInDays) : t0)));
    ;
  ...
  (range$.NextNDaysFromTodayRange.afterToday = function(clock, lengthInDays, title = null) {
    let t0;
    range$.NextNDaysFromTodayRange.__proto__.new.call(this, date$.Date.today(ClockL().as(clock)), intL().as(lengthInDays), StringL().as((t0 = title, t0 == null ? range$.NextNDaysFromTodayRange._nextNDaysFromTodayMsg(lengthInDays) : t0)));
    ;
  }).prototype = range$.NextNDaysFromTodayRange.prototype;
  ...
  range$.WeekRange = class WeekRange extends core.Object {
    ...
    static _defaultTitle(weeksAgo) {
      return StringL().as(dart.notNull(weeksAgo) > 0 ? range$.WeekRange._weeksAgoMsg(weeksAgo) : range$.WeekRange._weeksFromNowMsg(-dart.notNull(weeksAgo)));
    }
    static _weeksAgoMsg(weeksAgo) {
      return intl.Intl.plural(intL().as(weeksAgo), {zero: "This week", one: "Last week", other: dart.str(weeksAgo) + " weeks ago", name: "_weeksAgoMsg", args: JSArrayOfObjectL().of([weeksAgo]), desc: "A date range spanning a single week in the past.", examples: C7 || CT.C7});
    }
    static _weeksFromNowMsg(weeksFromNow) {
      return intl.Intl.plural(intL().as(weeksFromNow), {zero: "This week", one: "Next week", other: dart.str(weeksFromNow) + " weeks from now", name: "_weeksFromNowMsg", args: JSArrayOfObjectL().of([weeksFromNow]), desc: "A date range spanning a single week in the future.", examples: C8 || CT.C8});
    }
  };
  ...
  range$.MonthRange = class MonthRange extends core.Object {
    ...
    static _defaultTitle(monthsAgo) {
      return StringL().as(dart.notNull(monthsAgo) > 0 ? range$.MonthRange._monthsAgoMsg(monthsAgo) : range$.MonthRange._monthsFromNowMsg(-dart.notNull(monthsAgo)));
    }
    static _monthsAgoMsg(monthsAgo) {
      return intl.Intl.plural(intL().as(monthsAgo), {zero: "This month", one: "Last month", other: dart.str(monthsAgo) + " months ago", name: "_monthsAgoMsg", args: JSArrayOfObjectL().of([monthsAgo]), desc: "A date range spanning a single month in the past.", examples: C10 || CT.C10});
    }
    static _monthsFromNowMsg(monthsFromNow) {
      return intl.Intl.plural(intL().as(monthsFromNow), {zero: "This month", one: "Next month", other: dart.str(monthsFromNow) + " months from now", name: "_monthsFromNowMsg", args: JSArrayOfObjectL().of([monthsFromNow]), desc: "A date range spanning a single month in the future.", examples: C11 || CT.C11});
    }
  };
  ...
  range$.YearRange = class YearRange extends core.Object {
    ...
    static _defaultTitle(yearsAgo) {
      return StringL().as(dart.notNull(yearsAgo) > 0 ? range$.YearRange._yearsAgoMsg(yearsAgo) : range$.YearRange._yearsFromNowMsg(-dart.notNull(yearsAgo)));
    }
    static _yearsAgoMsg(yearsAgo) {
      return intl.Intl.plural(intL().as(yearsAgo), {zero: "This year", one: "Last year", other: dart.str(yearsAgo) + " years ago", name: "_yearsAgoMsg", args: JSArrayOfObjectL().of([yearsAgo]), desc: "A date range spanning a single year in the past.", examples: C16 || CT.C16});
    }
    static _yearsFromNowMsg(yearsFromNow) {
      return intl.Intl.plural(intL().as(yearsFromNow), {zero: "This year", one: "Next year", other: dart.str(yearsFromNow) + " years from now", name: "_yearsFromNowMsg", args: JSArrayOfObjectL().of([yearsFromNow]), desc: "A date range spanning a single year in the future.", examples: C17 || CT.C17});
    }
  };
  ...
  range$.QuarterRange = class QuarterRange extends core.Object {
    ...
    static _defaultTitle(quartersAgo) {
      return StringL().as(dart.notNull(quartersAgo) > 0 ? range$.QuarterRange._quartersAgoMsg(quartersAgo) : range$.QuarterRange._quartersFromNowMsg(-dart.notNull(quartersAgo)));
    }
    static _quartersAgoMsg(quartersAgo) {
      return intl.Intl.plural(intL().as(quartersAgo), {zero: "This quarter", one: "Last quarter", other: dart.str(quartersAgo) + " quarters ago", name: "_quartersAgoMsg", args: JSArrayOfObjectL().of([quartersAgo]), desc: "A date range spanning a single quarter in the past.", examples: C19 || CT.C19});
    }
    static _quartersFromNowMsg(quartersFromNow) {
      return intl.Intl.plural(intL().as(quartersFromNow), {zero: "This quarter", one: "Next quarter", other: dart.str(quartersFromNow) + " quarters from now", name: "_quartersFromNowMsg", args: JSArrayOfObjectL().of([quartersFromNow]), desc: "A date range spanning a single quarter in the future.", examples: C20 || CT.C20});
    }
  };
  ...
  range$._makeProtoBuf = function _makeProtoBuf(range) {
    ...
    return dart.test(range.isAllTime) ? (t0 = new date_range$46pb.DatepickerDateRange.new(), (() => {
      ...
      t0$.dateRange = DateRangeL().as(range$._makeDateRangeProto(range.start, range.end));
      return t0$;
    })());
  };
  ...
  dart.defineLazy(range$, {
    /*range$.allTime*/get allTime() {
      return range$.DatepickerDateRange.new(StringL().as(range$._allTimeMsg), null, null, {isPredefined: true, isAllTime: true});
    },
    set allTime(_) {},
