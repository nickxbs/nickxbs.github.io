define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_datepicker/model', 'packages/angular_components/material_datepicker/comparison.template', 'packages/angular/di.template', 'packages/angular_components/model/observable/observable.template', 'packages/angular_components/material_datepicker/range.template'], (function load__packages__angular_components__material_datepicker__model_template(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular_components__material_datepicker__model, packages__angular_components__material_datepicker__comparison$46template, packages__angular__di$46template, packages__angular_components__model__observable__observable$46template, packages__angular_components__material_datepicker__range$46template) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["model.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;AAeE,kBAAI;AACF;;AAEa,IAAf,4BAAW;AAEqD,IAAhE,0BAAuB,mCAAiB,cAAM;AACzB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAbI,yBAAQ;YAAG","file":"model.template.ddc.js"}');
  // Exports:
  return {
