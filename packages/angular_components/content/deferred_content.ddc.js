define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules'], (function load__packages__angular_components__content__deferred_content(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__angular__src__core__change_detection__change_detection, packages__angular__src__bootstrap__modules) {
  ...
  (deferred_content.DeferredContentDirective.new = function(_viewContainer, _template, parent) {
  ...
  (deferred_content.CachingDeferredContentDirective.new = function(_viewContainer, _template, parent) {
    this[_disposer] = new disposer.Disposer.oneShot();
    this[_view] = null;
    this[_visible] = false;
    this[_viewContainer$] = _viewContainer;
    this[_template$] = _template;
    this[_disposer].addStreamSubscription(boolL(), parent.contentVisible.listen(dart.bind(this, _setVisible)));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["deferred_content.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAoCO;;;;;;oCAOgC;AACd,MAArB,sBAAgB,KAAK;AACR,MAAb;IACF;;;AAQO,kBAAiB,UAAT,6BAAY;AACzB,UAAI,AAAM,KAAD,WAAI,eAAQ;AACrB,UAAI,KAAK;AACP,sBAAI;AAEmB,UAArB,AAAa;;AAEwC,QAAvD,iBAAW,AAAe,yCAAmB;;AAE7C,sBAAI;AAEE,2BAAgC,yCAApB,OAAU,sBAAV,OAAuB;AACnC,kCAAU,AAAU,SAAD,iBAAc,AAAU,SAAD,WAAS;AACvD,cAAY,kBAAR,OAAO;AAGL,6BAAa,AAAQ,OAAD;AAGa,mBAFrC,AAAa;YAAA;AACT,6BACF,SADa,AAAW,UAAD,YAAO;AAC5B,8BAAiC,SAArB,AAAW,UAAD,aAAQ;;;;;AAKhB,QAAtB,AAAe;AAEf,sBAAI;AAEE,kCAAY,AAAe,8CAAA,OAAS;AACxC,sBAAI,SAAS,iBAAT,OAAW,mCAAc;AAC+B,YAArC,WAAX,WAAV,SAAS,kCAAyB,oBAAc,SAAS;;;;AAIjD,MAAd,eAAS,KAAK;IAChB;;AAYqB,MAAnB,AAAU;AACW,MAArB,wBAAiB;AACD,MAAhB,mBAAY;IACd;;4DAZS,gBAAqB,WAAgC;IAtExD,kBAAqB;IACrB,qBAAe;IAGL;IAUX,2BAAqB;IAarB,eAAS;IACT,iBAAW;IACX,sBAAgB;IAyCZ;IAAqB;AAIzB,IAHH,AAAU,+CAAsB,AAAO,AAAe,MAAhB,uBAAuB,QAAC;AAC5C,MAAhB,iBAAW,KAAK;AACH,MAAb;;EAEJ;;;;;;;;;;;;;;;;;;;;;;;;;;;;kBA4BsB;AACpB,UAAU,YAAN,KAAK,EAAI,iBAAU;AACvB,oBAAI,KAAK,KAAI,AAAM,eAAG;AACgC,QAApD,cAAQ,AAAe,yCAAmB;;AAE5B,MAAhB,iBAAW,KAAK;IAClB;;AASqB,MAAnB,AAAU;AACW,MAArB,wBAAiB;AACD,MAAhB,mBAAY;IACd;;mEATS,gBAAqB,WAAgC;IAfxD,kBAAqB;IACnB;IAGH,iBAAW;IAWP;IAAqB;AAC8C,IAA1E,AAAU,+CAAsB,AAAO,AAAe,MAAhB,iCAAuB;EAC/D","file":"deferred_content.ddc.js"}');
  // Exports:
  return {
