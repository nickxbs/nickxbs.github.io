define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service'], (function load__packages__angular_components__scorecard__scorecard_bar(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__browser__dom_service__dom_service) {
  ...
  var L0 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/angular_components/scorecard/scorecard_bar.dart";
  ...
  scorecard_bar.ScorecardBarDirective = class ScorecardBarDirective extends core.Object {
    ngOnInit() {
      ...
      this[_disposer].addDisposable(StreamSubscriptionL(), this[_domService$].trackLayoutChange(StringL(), dart.fn(() => dart.toString(this.currentClientSize) + " " + dart.toString(this.currentScrollSize), VoidToStringL()), dart.fn(_ => {
        this[_readElement]({windowResize: true});
        this[_refreshController].add(true);
      }, dynamicToNullN()), {runInAngularZone: true}));
    }
    ngOnDestroy() {
    ...
    scrollBack() {
      this[_disposer].addDisposable(DisposableL(), this[_domService$].scheduleRead(dart.fn(() => {
        ...
        if (!(dart.notNull(this[_buttonSize]) > 0)) dart.assertFailed(null, L0, 133, 14, "_buttonSize > 0");
    ...
    scrollForward() {
      this[_disposer].addDisposable(DisposableL(), this[_domService$].scheduleRead(dart.fn(() => {
        this[_readElement]();
        let newValue = this[_scrollingMove];
        if (!(dart.notNull(this[_buttonSize]) > 0)) dart.assertFailed(null, L0, 155, 14, "_buttonSize > 0");
    ...
    [_readElement](opts) {
      ...
      if (!dart.test(this[_domService$].isReadingDom)) dart.assertFailed(null, L0, 189, 12, "_domService.isReadingDom");
