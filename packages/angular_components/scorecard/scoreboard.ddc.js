define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/utils/color/palette', 'packages/angular_components/scorecard/scorecard', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/scorecard/scorecard_bar', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/intl/intl'], (function load__packages__angular_components__scorecard__scoreboard(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__angular_components__model__selection__selection_model, packages__angular_components__utils__color__palette, packages__angular_components__scorecard__scorecard, packages__angular__src__core__change_detection__change_detection, packages__angular_components__scorecard__scorecard_bar, packages__angular_components__utils__browser__dom_service__dom_service, packages__intl__intl) {
  ...
  const palette = packages__angular_components__utils__color__palette.utils__color__palette;
  ...
  scoreboard.ScoreboardComponent = class ScoreboardComponent extends core.Object {
    ...
    [_onScorecardsChange]() {
      ...
      if (this.type == scoreboard.ScoreboardType.selectable) {
        ...
        for (let scorecard of this[_scorecards]) {
          t0$ = scorecard;
          t0$.selectedColor == null ? t0$.selectedColor = palette.chartingPalette[$_get](i[$modulo](palette.chartingPalette[$length])) : null;
          i = i + 1;
        }
      }
      this[_refreshArrows]();
