define(['dart_sdk', 'packages/intl/intl'], (function load__packages__angular_components__material_input__material_percent_directive(dart_sdk, packages__intl__intl) {
    ...
    [_replaceErrorMessage](errors) {
      ...
      for (let key of material_percent_directive.MaterialPercentInputDirective._errorOverrides[$keys]) {
        if (dart.test(material_percent_directive.MaterialPercentInputDirective._errorOverrides[$containsKey](key))) {
          ...
          dart.dsend(overrides, '_set', [key, material_percent_directive.MaterialPercentInputDirective._errorOverrides[$_get](key)]);
        }
      }
      let result = (t0 = overrides, t0 == null ? errors : t0);
      return MapLOfStringL$dynamic().as(this.percentErrorRenderer != null ? (t0$ = result, dart.dsend(this, 'percentErrorRenderer', [t0$])) : result);
    }
  };
  ...
  dart.setFieldSignature(material_percent_directive.MaterialPercentInputDirective, () => ({
    ...
    percentErrorRenderer: dart.fieldType(dart.legacy(core.Function))
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_percent_directive.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;IA8DW;;;;;;2BApBsD;;AACzD;AACJ,eAAS,MAAO,AAAgB;AAC9B,sBAAI,AAAgB,uFAAY,GAAG;AACc,UAA/C,AAAU,SAAD,IAAC,OAAV,YAAc,sCAA0B,MAAM,IAApC;AAC2B,UAA5B,WAAT,SAAS,WAAC,GAAG,EAAI,AAAe,gFAAC,GAAG;;;AAGlC,oBAAmB,KAAV,SAAS,QAAT,OAAa,MAAM;AAClC,wCAAQ,AAAqB,6BAAG,cACL,MAAM,EAAP,WAApB,wCACA,MAAM;IACd;;2EAhC2B,OAAmB;IAwCrC;AArCY,IAAnB,AAAM,KAAD,QAAQ;AACU,IAAvB,AAAM,KAAD,cAAc;AACA,IAAnB,AAAQ,OAAD,OAAO;AACR,yBAA8B;AAC9B,0BAAkB,AAAe,AAAQ,AAC1C,cADiC,mCACzB,AAAe,AAAQ,cAAT;AAG3B,QAAI,AAAgB,eAAD,GAAG,AAAe,AAAQ,AAAgB,AAAO,cAAhC,kCAAkC;AACjB,MAAnD,AAAM,KAAD,gBAAgB,AAAe,AAAQ,cAAT;;AAEe,MAAlD,AAAM,KAAD,eAAe,AAAe,AAAQ,cAAT;;AAEM,IAA1C,AAAM,KAAD,2BAAiB;EACxB;;;;;;;;;;;;;MAyB2B,wEAAe;YAAG,4DACP,0GACL,uGACA;;;MAGpB,kFAAyB;YAAQ,mBAC1C,2CACI,AAAE,oEACF,uCACA;;MAEK,+EAAsB;YAAQ,mBAAQ,gCAC3C,AAAE,mEACF,kBACG,AAAE,+DACL;;MAEK,+EAAsB;YAAQ,mBAAQ,iCAC3C,AAAE,mEACF,kBACG,AAAE,+DACL","file":"material_percent_directive.ddc.js"}');
  // Exports:
  return {
