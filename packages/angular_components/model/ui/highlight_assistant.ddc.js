define(['dart_sdk', 'packages/angular_components/model/ui/highlighted_text_model'], (function load__packages__angular_components__model__ui__highlight_assistant(dart_sdk, packages__angular_components__model__ui__highlighted_text_model) {
  ...
  var LinkedMapOfStringL$MapLOfdynamic$ListLOfHighlightedTextSegmentL = () => (LinkedMapOfStringL$MapLOfdynamic$ListLOfHighlightedTextSegmentL = dart.constFn(_js_helper.LinkedMap$(StringL(), MapLOfdynamic$ListLOfHighlightedTextSegmentL())))();
  ...
  (highlight_assistant.HighlightAssistant.new = function(opts) {
    ...
    this[_highlightCache] = new (LinkedMapOfStringL$MapLOfdynamic$ListLOfHighlightedTextSegmentL()).new();
