define(['dart_sdk', 'packages/quiver/src/time/clock', 'packages/logging/logging', 'packages/angular/src/core/change_detection/change_detection'], (function load__packages__angular_components__model__date__time_zone_aware_clock(dart_sdk, packages__quiver__src__time__clock, packages__logging__logging, packages__angular__src__core__change_detection__change_detection) {
  'use strict';
  ...
  var CompleterOfNullN = () => (CompleterOfNullN = dart.constFn(async.Completer$(core.Null)))();
  ...
  (time_zone_aware_clock.SettableTimeZone.new = function(timeFunc = C0 || CT.C0, throwIfNotInitialized = false) {
    this[_initialized] = CompleterOfNullN().new();
  ...
  }, '{"version":3,"sourceRoot":"","sources":["time_zone_aware_clock.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA4DuB;IAAoB;;2DAPL;AAAY,sEAAe,UAAT,QAAQ;;EAAM;6DAIlC;AAAQ,sEAAM,cAAM,IAAI;;EAAC;;;;;;;;;;;;;;;;;AAyB7B;IAAc;sBACjB;AACzB,UAAI,SAAS,IAAI,QAAQ,AAAU,AAAe,SAAhB,mBAAmB;AAEU,QAD7D,WAAoB,6BAChB,SAAS,EAAE,cAAY;;AAE7B,UAAI,SAAS,IAAI,QAAQ,AAAU,AAAe,SAAhB;AAC2B,QAA3D,WAAoB,6BAAM,SAAS,EAAE,cAAY;;AAGnD,qBAAK,AAAa,mCAAe,SAAS,IAAI;AACrB,QAAvB,AAAa;;AAEW,MAA1B,uBAAiB,SAAS;IAC5B;;AAK0B,YAAA,AAAe,yBAAG;IAAI;;AAIrB,YAAA,AAAa;IAAM;;AAkBxC,uBAAa,AAAK;AACtB,UAAI,AAAc,sBAAG;AAEnB,uBAAI;AAE2D,UAD7D,WAAM,wBACF;;AAEiD,UAArD,AAAQ,qCAAO;AACf,gBAAO,WAAU;;YAEd,KAAI,AAAW,AAAe,AAAe,UAA/B,kCAAkC;AAEkB,QADvE,WAAM,wBACF,AAAkE,mEAAX,UAAU;YAChE,KAAI,AAAW,AAAe,AAAe,UAA/B;AACmD,QAAtE,WAAM,wBAAW,AAAoD,qDAAX,UAAU;;AAKlE,mBAAS,AAAc,wBAAE,AAAW,UAAD;AACvC,UAAI,AAAO,AAAe,MAAhB,mBAAmB;AAEmC,QAD9D,WAAM,wBAAU,AAAC,yDACX,sBAAa,iBAAK,AAAW,UAAD,mBAAgB,iBAAI,MAAM;;AAE9D,UAAI,AAAO,AAAe,MAAhB;AAEsD,QAD9D,WAAM,wBAAU,AAAC,2CACX,sBAAa,iBAAK,AAAW,UAAD,mBAAgB,iBAAI,MAAM;;AAE9D,YAAO,AAAW,WAAD,KAAK,MAAM;IAC9B;;yDArCkB,wBAA4B;IAxCxC,qBAAe;IAuBZ;IAkBG,cAAE,QAAQ;IACO,+BAAE,qBAAqB;;;;;;;;;;;;;;;;;;;;;;;;;;;6DArDlB;AAAa,4DAAmB,QAAQ;EAAC;;AAK/B;EAAkB;;;;;;;;;;;;;;;;;;;;;;MA1D1D,6BAAO;YACT,mBAAO;;MAOL,wCAAkB;;;MAIlB,iDAA2B;;;MAO3B,8CAAwB","file":"time_zone_aware_clock.ddc.js"}');
  // Exports:
  return {
