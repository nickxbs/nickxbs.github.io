define(['dart_sdk', 'packages/intl/intl'], (function load__packages__angular_components__model__date__date_formatter(dart_sdk, packages__intl__intl) {
  ...
  date_formatter.formatRange = function formatRange(range) {
    ...
    if (range.start == null && range.end == null) return date_formatter._DateFormatterMessages._allTimeMsg;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["date_formatter.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;gCAyD4C,QAAe,MAAa,QACvD,MAAa;AACxB,YAAK,mBAA8C,SAApC,MAAM,mBAAE,IAAI,qBAAI,MAAM,mBAAE,IAAI,oBAAG,IAAI,UACxC,qDACF,AAAE,gEACF,oEACA,+DACE,uBACJ,MAAM,EACN,IAAI,EACJ,MAAM,EACN,IAAI,EACJ,IAAI;IAQJ;iCAGK,OAAc,MAAa,MAAa;AACnD,YAAK,mBAAqC,SAA3B,KAAK,mBAAE,IAAI,qBAAI,IAAI,oBAAG,IAAI,UAC/B,sDACF,AAAE,gEACF,iEACA,mEACE,uBACJ,KAAK,EACL,IAAI,EACJ,IAAI,EACJ,IAAI;IAOJ;iCAEiC,OAAc;AACrD,YAAK,mBAAuB,SAAb,KAAK,qBAAI,GAAG,UACjB,sDACF,AAAE,iEACF,+DACA,8DACA,oCACE,uBAAC,KAAK,EAAE,GAAG;IAC+C;;;;EAC1E;;;;;MA1De,iDAAW;YAAQ,mBAAQ,mBAC9B,qBACA;;;sEArC2B;AACnC,UAAA,AAAO,OAAD,KAAI,UAAU,qCAAsB;EAAW;kDAGlC,MAAkB;;AACrC,oBAAI,eAAJ,OAAM,WAAc,KAAP,MAAM,QAAN,OAAU;kBAAvB,OAAuC;EAAE;oDAChB;AAC3B,QAAI,AAAM,KAAD,IAAI,MAAM,MAAO;AAC1B,QAAI,AAAM,AAAM,KAAP,UAAU,QAAQ,AAAM,AAAI,KAAL,QAAQ,MACtC,MAA8B;AAChC,QAAgB,YAAZ,AAAM,KAAD,QAAU,AAAM,KAAD,OAAM,MAAO,2BAAW,AAAM,KAAD,QAAQ;AAE7D,QAAI,AAAM,AAAM,KAAP,UAAU,QACf,AAAM,AAAI,KAAL,QAAQ,QACb,AAAM,AAAM,KAAP,eAAe,AAAM,AAAI,KAAL;AACrB,mBAAS,oCAA0B;AACzC,YAA8B,6DAC1B,0BAAW,AAAM,KAAD,QAAQ,MAAM,GAAG,0BAAW,AAAM,KAAD,MAAM,MAAM;;AAEnE,QAAI,AAAM,AAAM,KAAP,gBAAgB,AAAM,AAAI,KAAL;AAC5B,YAA8B,4DAC1B,AAAM,AAAM,KAAP,cAAc,8BACnB,AAAM,AAAM,KAAP,cAAc,4BACnB,AAAM,AAAI,KAAL,YAAY,8BACjB,AAAM,AAAI,KAAL,YAAY,4BACjB,AAAM,AAAM,KAAP,cAAc;;AAEzB,UAA8B,6DAC1B,AAAM,AAAM,KAAP,cAAc,8BACnB,AAAM,AAAM,KAAP,cAAc,4BACnB,AAAM,AAAI,KAAL,YAAY,4BACjB,AAAM,AAAM,KAAP,cAAc;EACzB;;MAxCM,yBAAU;YAAc;;MACxB,0BAAW;YAAc;;MACzB,0BAAW;YAAc;;MACzB,2BAAY;YAAc;;MAG1B,kCAAmB;YAAG,yBAAW","file":"date_formatter.ddc.js"}');
  // Exports:
  return {
