define(['dart_sdk', 'packages/observable/observable'], (function load__packages__angular_components__model__selection__selection_model(dart_sdk, packages__observable__observable) {
  ...
  var SelectionChangeRecordOfNullN = () => (SelectionChangeRecordOfNullN = dart.constFn(selection_model.SelectionChangeRecord$(core.Null)))();
  var SelectionChangeRecordLOfNullN = () => (SelectionChangeRecordLOfNullN = dart.constFn(dart.legacy(SelectionChangeRecordOfNullN())))();
  var ListOfSelectionChangeRecordLOfNullN = () => (ListOfSelectionChangeRecordLOfNullN = dart.constFn(core.List$(SelectionChangeRecordLOfNullN())))();
  var ListLOfSelectionChangeRecordLOfNullN = () => (ListLOfSelectionChangeRecordLOfNullN = dart.constFn(dart.legacy(ListOfSelectionChangeRecordLOfNullN())))();
  ...
  dart.defineLazy(CT, {
    ...
    get C7() {
      return C7 = dart.constList([], ListLOfSelectionChangeRecordLOfNullN());
    },
    get C8() {
  ...
  var isSingleSelect$ = dart.privateName(selection_model, "SelectionModel.isSingleSelect");
  ...
  var isSingleSelect$0 = dart.privateName(selection_model, "_NoopSelectionModelImpl.isSingleSelect");
