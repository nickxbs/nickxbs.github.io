define(['dart_sdk', 'packages/observable/observable', 'packages/angular_components/model/menu/menu_item_affix', 'packages/angular_components/material_menu/affix/base_affix', 'packages/angular/src/bootstrap/modules', 'packages/quiver/core', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection'], (function load__packages__angular_components__material_menu__menu_item_affix_list(dart_sdk, packages__observable__observable, packages__angular_components__model__menu__menu_item_affix, packages__angular_components__material_menu__affix__base_affix, packages__angular__src__bootstrap__modules, packages__quiver__core, packages__angular_components__interfaces__has_disabled, packages__angular__src__core__change_detection__change_detection) {
  'use strict';
  ...
  var ListLOfListChangeRecordLOfMenuItemAffixLToNullN = () => (ListLOfListChangeRecordLOfMenuItemAffixLToNullN = dart.constFn(dart.fnType(core.Null, [ListLOfListChangeRecordLOfMenuItemAffixL()])))();
  ...
  menu_item_affix_list.MenuItemAffixListComponent = class MenuItemAffixListComponent extends core.Object {
    ...
    set items(items) {
      ...
      }, ListLOfListChangeRecordLOfMenuItemAffixLToNullN())));
    ...
    [_initializeItems](items) {
      let t0;
      this[_clearChildren]();
      t0 = this[_affixComponentRefs];
      (() => {
        t0[$addAll](items[$map](_AffixRefL(), dart.fn(affix => this[_createComponentRef](affix), BaseMenuItemAffixModelLTo_AffixRefL())));
        return t0;
      })();
    }
