define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/focus/focus', 'packages/angular_forms/src/directives', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/events/events', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/model/ui/icon'], (function load__packages__angular_components__material_radio__material_radio(dart_sdk, packages__angular_components__utils__disposer__disposer, packages__angular_components__model__selection__selection_model, packages__angular_components__focus__focus, packages__angular_forms__src__directives, packages__angular__src__core__change_detection__change_detection, packages__angular_components__utils__browser__events__events, packages__angular_components__interfaces__has_disabled, packages__angular_components__model__ui__icon) {
  'use strict';
  ...
  var ListLOfSelectionChangeRecordLOfMaterialRadioComponentLToNullN = () => (ListLOfSelectionChangeRecordLOfMaterialRadioComponentLToNullN = dart.constFn(dart.fnType(core.Null, [ListLOfSelectionChangeRecordLOfMaterialRadioComponentL()])))();
  ...
  var valueSelection = dart.privateName(material_radio_group, "MaterialRadioGroupComponent.valueSelection");
  ...
  (material_radio_group.MaterialRadioGroupComponent.new = function(_ngZone, cd) {
    ...
    }, ListLOfSelectionChangeRecordLOfMaterialRadioComponentLToNullN())));
  ...
  dart.setFieldSignature(material_radio_group.MaterialRadioGroupComponent, () => ({
    ...
    valueSelection: dart.fieldType(dart.legacy(selection_model.SelectionModel)),
