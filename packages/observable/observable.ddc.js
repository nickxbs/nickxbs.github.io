define(['dart_sdk', 'packages/collection/src/comparators', 'packages/collection/src/canonicalized_map', 'packages/quiver/core', 'packages/dart_internal/extract_type_arguments'], (function load__packages__observable__observable(dart_sdk, packages__collection__src__comparators, packages__collection__src__canonicalized_map, packages__quiver__core, packages__dart_internal__extract_type_arguments) {
  ...
  var IdentityEqualityOfNullN = () => (IdentityEqualityOfNullN = dart.constFn(equality$.IdentityEquality$(core.Null)))();
  var _EditL = () => (_EditL = dart.constFn(dart.legacy(differs._Edit)))();
  var MapChangeRecordOfNullN$NullN = () => (MapChangeRecordOfNullN$NullN = dart.constFn(records$.MapChangeRecord$(core.Null, core.Null)))();
  var MapChangeRecordLOfNullN$NullN = () => (MapChangeRecordLOfNullN$NullN = dart.constFn(dart.legacy(MapChangeRecordOfNullN$NullN())))();
  ...
  var ListChangeRecordOfNullN = () => (ListChangeRecordOfNullN = dart.constFn(records$.ListChangeRecord$(core.Null)))();
  var ListChangeRecordLOfNullN = () => (ListChangeRecordLOfNullN = dart.constFn(dart.legacy(ListChangeRecordOfNullN())))();
  ...
  var PropertyChangeRecordOfNullN = () => (PropertyChangeRecordOfNullN = dart.constFn(records$.PropertyChangeRecord$(core.Null)))();
  ...
  var L2 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/observable/src/internal.dart";
  ...
  var L1 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/observable/src/differs/list_differ.dart";
  var L8 = "package:observable/src/observable_list.dart";
  var L4 = "file:///C:/Users/nicol/AppData/Local/Temp/scratch_space31d894d0/packages/observable/src/records/list_change_record.dart";
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C1 = dart.const({
        __proto__: IdentityEqualityOfNullN().prototype
      });
    },
    get C2() {
    ...
    get C7() {
      return C7 = dart.constList([], MapChangeRecordLOfNullN$NullN());
    },
    get C8() {
      return C8 = dart.constList([], ListChangeRecordLOfNullN());
    },
    get C9() {
  ...
  observable_map.ObservableMap$ = dart.generic((K, V) => {
    ...
    class ObservableMap extends observable.Observable$(dart.legacy(records$.ChangeRecord)) {
      ...
      [_notifyKeysValuesChanged]() {
        this.notifyChange(new (PropertyChangeRecordOfNullN()).new(this, C15 || CT.C15, null, null));
        this[_notifyValuesChanged]();
      }
      [_notifyValuesChanged]() {
        this.notifyChange(new (PropertyChangeRecordOfNullN()).new(this, C16 || CT.C16, null, null));
      }
    }
