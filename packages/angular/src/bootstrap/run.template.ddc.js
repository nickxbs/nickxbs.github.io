define(['dart_sdk', 'packages/angular/core.template', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/application_tokens.template'], (function load__packages__angular__src__bootstrap__run_template(dart_sdk, packages__angular__core$46template, packages__angular__src__core__change_detection__change_detection$46template, packages__angular__src__bootstrap__modules, packages__angular__src__core__application_tokens$46template) {
  'use strict';
  ...
  var json_pipe$46template = Object.create(dart.library);
