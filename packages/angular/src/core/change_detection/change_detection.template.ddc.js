define(['dart_sdk'], (function load__packages__angular__src__core__change_detection__change_detection_template(dart_sdk) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  var opaque_token$46template = Object.create(dart.library);
  ...
  var decorators$46template = Object.create(dart.library);
  var providers$46template = Object.create(dart.library);
  ...
  var metadata$46template = Object.create(dart.library);
  ...
  var provider$46template = Object.create(dart.library);
