define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/bootstrap/run.template'], (function load__packages__angular__experimental_template(dart_sdk, packages__angular__angular$46template, packages__angular__src__core__change_detection__change_detection$46template, packages__angular__src__bootstrap__modules, packages__angular__src__bootstrap__run$46template) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["src/common/directives/ng_for_identity.template.dart","experimental.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;AAUE,kBAAI;AACF;;AAEa,IAAf,sCAAW;AAEU,IAArB;EACF;;MARI,mCAAQ;YAAG;;;;;ACWb,kBAAI;AACF;;AAEa,IAAf,mCAAW;AAEU,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAjBI,gCAAQ;YAAG","file":"experimental.template.ddc.js"}');
  // Exports:
  return {
