define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection.template'], (function load__packages__angular__di_template(dart_sdk, packages__angular__src__core__change_detection__change_detection$46template) {
  'use strict';
